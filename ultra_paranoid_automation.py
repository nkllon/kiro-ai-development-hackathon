...
def ultra_paranoid_step_1():
    ...
    # Click My Projects
    if not safe_click_with_verification("My projects", ["Edit project", "Create project"]):
...
def ultra_paranoid_step_2():
    ...
    # Click Edit project
    if not safe_click_with_verification("Edit project", ["Project name", "Elevator pitch", "About the project"]):
...
def main():
    ...
    steps = [
        ultra_paranoid_step_1,
        ultra_paranoid_step_2,
        ultra_paranoid_step_3
    ]
