...
Examples:
  ...
  python langgraph_devpost_cli.py list
    ...
    input_parser = subparsers.add_parser("input", help="Provide input for interactive recovery")
    input_parser.add_argument(
        "workflow_id",
        help="Workflow ID to provide input for"
    )
    input_parser.add_argument(
        "user_input",
        help="User input/choice for recovery or memory qualification"
    )
    input_parser.add_argument(
        "--output",
        help="Output file for workflow results after input"
    )
