...
def handle_manage_team_page():
    ...
    try:
        ...
        for p_info in pages_info:
            if "devpost.com" in p_info.get("url", "") and "manage-team" in p_info.get("url", ""):
        ...
        print("💡 The Manage Team page is for inviting team members, not for saving progress.")
        ...
        if email_input:
            ...
            print(f"      • Email input: {email_input.get_attribute('placeholder') or 'Email address'}")
            ...
            if choice == "0":
                ...
                if email_input:
                    ...
                    if email:
                        ...
                        send_button = target_page.query_selector("button:has-text('Send invite')")
                ...
                next_step = target_page.query_selector("#steps-navigation a.step:not(.current):not(.completed)")
                ...
                prev_step = target_page.query_selector("#steps-navigation a.step.completed")
                ...
                team_members = target_page.query_selector_all("[class*='team-member'], [class*='member']")
