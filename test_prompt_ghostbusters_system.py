...
def test_ghostbusters_consultation_system():
        ...
        "session_save_data": {
            "current_page_data": {
                ...
                "navigation": [
                    ...
                    {"text": "Unknown Link", "type": "link", "href": "https://unknown.com"}
                ],
                "buttons": [
    ...
    print(f"   Navigation analysis: {investigation['navigation_analysis']['total_elements']} elements")
    print(f"   Form analysis: {investigation['form_analysis']['total_buttons']} buttons")
...
def demonstrate_complete_system():
    ...
    print("   → 'Stand by for briefing: Current situation requires tactical discussion!'")
    ...
    print("   → 'Primary Strategy: form_focused'")
    print("   → 'Recommendation: This is a DevPost form page - use form completion strategy'")
