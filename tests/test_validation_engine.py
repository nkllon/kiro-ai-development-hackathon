...
Enhanced: 2025-09-14T06:30:15.493726
"""
...
from src.devpost_integration.validation_engine import (
...
from src.devpost_integration.models import (
    ProjectMetadata, DevpostProject, TeamMember, ProjectLink
)
...
class TestValidationIssue(ReflectiveModule):
    ...
    def test_validation_issue_creation(self):
        ...
        assert issue.suggestion == "Please provide a title"
...
class TestValidationRules(ReflectiveModule):
    ...
    def sample_metadata(self):
        ...
        return ProjectMetadata(
            title="Test Project",
            tagline="A comprehensive test project for validation",
            description="This is a detailed description of the test project that meets the minimum length requirements and provides comprehensive information about the project's goals and implementation.",
    ...
    def test_tag_validation_rule(self):
        ...
        metadata = ProjectMetadata(
            title="", tagline="", description="",
            tags=["python", "web", "api", "database", "frontend", "backend"]
        )
        issues = rule.validate(metadata)
        assert len(issues) == 1
...
class TestValidationEngine(ReflectiveModule):
    ...
    def sample_metadata(self):
        ...
        return ProjectMetadata(
            title="Test Project",
            tagline="A comprehensive test project for validation testing",
            description="This is a detailed description of the test project that meets the minimum length requirements and provides comprehensive information about the project's goals, implementation details, and expected outcomes.",
            tags=["python", "testing", "validation", "automation"],
            team_members=["Alice", "Bob"],
            repository_url="https://github.com/user/project",
            demo_url="https://example.com/demo",
            video_url="https://youtube.com/watch?v=test"
    ...
    def test_validate_metadata_with_issues(self, validation_engine):
        ...
        bad_metadata = ProjectMetadata(
            title=None,  # Missing title (None instead of empty string)
            tagline="Short",  # Too short tagline
    ...
    def test_validate_project(self, validation_engine):
        ...
        project = DevpostProject(
            ...
            title="Test Project",
            tagline="A comprehensive test project for validation",
            description="This is a detailed description that meets all requirements.",
            hackathon_id="hackathon-456",
            hackathon_name="Test Hackathon",
            tags=["python", "testing"],
            team_members=[TeamMember(name="Alice"), TeamMember(name="Bob")],
            links=[
                ProjectLink(title="Repository", url="https://github.com/user/project", link_type="github"),
    ...
    def test_calculate_overall_score(self, validation_engine):
        ...
        issues = [
            ...
            ValidationIssue("field2", ValidationCategory.CONTENT_QUALITY, ValidationSeverity.ERROR, "Error issue"),
    ...
    def test_get_validation_suggestions(self, validation_engine):
        ...
        issues = [
            ...
            ValidationIssue(
                "description", ValidationCategory.CONTENT_QUALITY, ValidationSeverity.WARNING,
    ...
    def test_export_validation_report_json(self, validation_engine):
        ...
        issues = [
            ValidationIssue(
                "title", ValidationCategory.REQUIRED_FIELDS, ValidationSeverity.ERROR,
...
from src.multi_instance_orchestration.core.reflective_module import ReflectiveModule
        ...
        requirements = [
            SubmissionRequirement(
                ...
                title="Video Demo",
                description="Submit a 2-minute video demo",
                required=True,
                completed=False
            ),
            SubmissionRequirement(
                ...
                title="Source Code",
                description="Provide link to source code",
                required=True,
                completed=True
            )
        ]
    ...
    def test_get_missing_requirements(self, validation_engine):
        ...
        issues = [
            ValidationIssue(
                "title", ValidationCategory.REQUIRED_FIELDS, ValidationSeverity.CRITICAL,
                "Title is missing", fix_action="Add a title to your project"
            ),
            ValidationIssue(
                "video_demo", ValidationCategory.HACKATHON_SPECIFIC, ValidationSeverity.ERROR,
    ...
    def test_enhanced_validation_suggestions(self, validation_engine):
        ...
        issues = [
            ...
            ValidationIssue(
                "description", ValidationCategory.CONTENT_QUALITY, ValidationSeverity.WARNING,
                "Description could be longer", suggestion="Consider expanding the description",
        ...
        assert any("Content Quality:" in s for s in suggestions)
