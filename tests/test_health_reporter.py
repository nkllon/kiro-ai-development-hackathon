...
Enhanced: 2025-09-14T06:30:15.568158
"""
...
class TestHealthTrendAnalyzer:
    ...
    def test_record_and_analyze_metrics(self):
        ...
        overall_trend = next(
            (t for t in trends if t.metric_name == "overall_health_score"), None
        )
    ...
    def test_data_retention(self):
        ...
        with patch(
            "src.beast_mode.domain_index.health_reporter.datetime"
        ) as mock_datetime:
...
class TestAlertManager:
    ...
    def create_test_health_status(
        self, overall_score: float, issues: List[HealthIssue] = None
    ) -> HealthStatus:
    ...
    def test_threshold_alert_triggering(self):
        ...
        health_statuses = {
            "critical_domain": self.create_test_health_status(
                0.2
            ),  # Below 0.3 threshold
    ...
    def test_alert_cooldown(self):
        ...
        health_statuses = {"critical_domain": self.create_test_health_status(0.2)}
...
class TestHealthReportGenerator:
    ...
    def create_mock_health_monitor(self):
        ...
        mock_monitor.check_domain_health.side_effect = lambda name: health_statuses.get(
            name
        )
        ...
        mock_analyzer.perform_comprehensive_analysis.return_value = {
            ...
            "dependency_health": {
                "highly_coupled_domains": [
                    {"domain": "coupled_domain", "dependent_count": 6}
                ]
            },
        }
    ...
    def test_full_health_report_generation(self):
        ...
        generator = HealthReportGenerator(
            health_monitor=mock_monitor, dependency_analyzer=mock_analyzer
        )
    ...
    def test_trend_report_generation(self):
        ...
        # Add some trend data
        generator.trend_analyzer.historical_data["test_domain"][
    ...
    def test_alert_integration(self):
        ...
        generator = HealthReportGenerator(
            health_monitor=mock_monitor, config={"auto_alerting_enabled": True}
        )
    ...
    def test_report_history_management(self):
        ...
        generator = HealthReportGenerator(
            health_monitor=mock_monitor, config={"report_retention_days": 1}
        )
