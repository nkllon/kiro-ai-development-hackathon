...
Enhanced: 2025-09-14T06:30:15.465211
"""
...
class TestDataModelValidation:
    ...
    def test_consolidation_plan_validation(self):
        ...
        plan.migration_steps = [
            MigrationStep(
                step_id="step-1", description="Test step", estimated_effort=8
            ),
            MigrationStep(
                step_id="step-2", description="Test step 2", estimated_effort=16
            ),
        ]
...
class TestControlModels:
    ...
    def test_validation_rule_model(self):
        ...
        is_valid, message = rule.validate_content(
            "This uses deprecated_term_1 in the text"
        )
...
class TestModelUtilities:
    ...
    def test_create_model_instance(self):
        ...
        instance = create_model_instance("SpecAnalysis", spec_id="test-spec")
