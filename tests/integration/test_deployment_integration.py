...
Enhanced: 2025-09-14T06:30:15.575852
"""
...
class TestDeploymentIntegration:
    ...
    def test_single_machine_deployment_workflow(self, mock_popen):
        ...
        # Create deployment
        deployment_id = self.deployment_manager.create_single_machine_deployment(
            "development"
        )
    ...
    def test_distributed_deployment_workflow(self):
        ...
        deployment_id = self.deployment_manager.create_distributed_deployment(
            "distributed", nodes
        )
    ...
    def test_validator_integration(self, mock_redis, mock_socket):
        ...
        report = self.validator.validate_deployment(
            "integration_test", "development", ValidationLevel.STANDARD
        )
    ...
    def test_complete_deployment_lifecycle(self, mock_redis, mock_socket, mock_popen):
        ...
        report = self.validator.validate_deployment(
            deployment_id, "lifecycle_test", ValidationLevel.BASIC
        )
    ...
    def test_environment_specific_configurations(self):
        ...
        for env in environments:
            ...
            assert (
                len(issues) == 0
            ), f"Environment {env} has validation issues: {issues}"
        ...
        def create_deployment(env_name):
            try:
                with patch("subprocess.Popen") as mock_popen:
                    ...
                    deployment_id = (
                        self.deployment_manager.create_single_machine_deployment(
                            env_name
                        )
                    )
