...
Enhanced: 2025-09-14T06:30:15.507690
"""
...
class TestFailurePrioritization:
    ...
    def test_correlation_priority_score(self, integrator):
        ...
        correlation_score = integrator._calculate_correlation_priority_score(
            base_failure, all_failures
        )
...
class TestBatchAnalysis:
    ...
    def test_shared_context_building(self, integrator, sample_failures):
        ...
        shared_context = integrator._build_shared_analysis_context(
            sample_failures, common_patterns
        )
    ...
    def test_common_pattern_detection(self, integrator):
        ...
        common_module_patterns = [
            p for p in error_patterns if "common_module" in p["pattern"]
        ]
...
class TestCorrelationDetection:
    ...
    def test_temporal_correlation_analysis(self, integrator):
        ...
        temporal_correlations = integrator._analyze_temporal_correlations(
            close_failures
        )
    ...
    def test_error_pattern_correlation_analysis(self, integrator):
        ...
        error_correlations = integrator._analyze_error_pattern_correlations(
            pattern_failures
        )
    ...
    def test_dependency_correlation_analysis(self, integrator, sample_failures):
        ...
        dependency_correlations = integrator._analyze_dependency_correlations(
            sample_failures
        )

        # Should find import failure correlations
        import_correlations = [
            c for c in dependency_correlations if c.get("subtype") == "import_failures"
        ]
    ...
    def test_environmental_correlation_analysis(self, integrator, sample_failures):
        ...
        environmental_correlations = integrator._analyze_environmental_correlations(
            sample_failures
        )
        ...
        ci_correlations = [
            c
            for c in environmental_correlations
