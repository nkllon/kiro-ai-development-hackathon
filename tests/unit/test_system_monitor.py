...
Enhanced: 2025-09-14T06:30:15.534334
"""
...
from src.beast_mode.monitoring.system_monitor import SystemMonitor, SystemStatus
...
from src.multi_instance_orchestration.core.reflective_module import ReflectiveModule
    ...
    def test_rdi_chain_validation(self):
        ...
        rdi_validation = {
            "module": "/Users/lou/kiro-2/kiro-ai-development-hackathon/tests/unit/test_system_monitor.py",
            "requirements": ['R1'],
            "validation_timestamp": "2025-09-14T06:24:50.704213",
...
class TestSystemMonitor(ReflectiveModule):
    ...
    async def test_get_system_status(self, system_monitor):
        ...
        system_monitor.metrics_collector.get_performance_report = MagicMock(return_value={
            "kpis": {
                ...
                "error_rate": {"error_rate_percent": 2.5},
        ...
        assert status.active_recoveries == 1
        assert status.message_throughput == 1000
    ...
    async def test_get_comprehensive_report(self, system_monitor):
        ...
        system_monitor.metrics_collector.get_performance_report = MagicMock(return_value={})
        system_monitor.alert_manager.get_alert_summary = MagicMock(return_value={})
        system_monitor.alert_manager.get_active_alerts = MagicMock(return_value=[])
        system_monitor.alert_manager.get_alert_history = MagicMock(return_value=[])
        system_monitor.recovery_manager.get_recovery_summary = MagicMock(return_value={})
    ...
    async def test_check_metric_alerts(self, system_monitor):
        ...
        system_monitor.metrics_collector.get_performance_report = MagicMock(return_value={
            "kpis": {
                "error_rate": {"error_rate_percent": 15.0},  # Above 10% threshold
                "message_latency": {"avg_ms": 1500.0}  # Above 1000ms threshold
            }
        })
        system_monitor.alert_manager.fire_alert = AsyncMock()
    ...
    async def test_alert_condition_functions(self, system_monitor):
        ...
        system_monitor.metrics_collector.get_performance_report = MagicMock(return_value={
            "kpis": {
                "error_rate": {"error_rate_percent": 8.0},  # Above 5% threshold
