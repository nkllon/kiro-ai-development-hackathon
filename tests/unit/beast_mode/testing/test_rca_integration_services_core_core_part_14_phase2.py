...
from src.beast_mode.testing.rca_integration_services_core_core_part_14 import (
    RcaIntegrationServicesCoreCorePart14,
)
...
class TestRcaIntegrationServicesCoreCorePart14Integration:
    ...
    def test_cross_module_integration(self):
        ...
        with patch(
            "src.beast_mode.testing.rca_integration_services_core_core_part_14.dependent_module"
        ) as mock_dep:
