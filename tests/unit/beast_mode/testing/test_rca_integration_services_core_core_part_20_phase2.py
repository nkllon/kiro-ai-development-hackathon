...
from src.beast_mode.testing.rca_integration_services_core_core_part_20 import (
    RcaIntegrationServicesCoreCorePart20,
)
...
class TestRcaIntegrationServicesCoreCorePart20Integration:
    ...
    def test_cross_module_integration(self):
        ...
        with patch(
            "src.beast_mode.testing.rca_integration_services_core_core_part_20.dependent_module"
        ) as mock_dep:
