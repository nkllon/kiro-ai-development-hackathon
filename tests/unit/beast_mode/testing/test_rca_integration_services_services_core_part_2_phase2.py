...
from src.beast_mode.testing.rca_integration_services_services_core_part_2 import (
    RcaIntegrationServicesServicesCorePart2,
)
...
class TestRcaIntegrationServicesServicesCorePart2Integration:
    ...
    def test_cross_module_integration(self):
        ...
        with patch(
            "src.beast_mode.testing.rca_integration_services_services_core_part_2.dependent_module"
        ) as mock_dep:
