...
from src.beast_mode.testing.rca_integration_services_core_core_part_8 import (
    RcaIntegrationServicesCoreCorePart8,
)
...
class TestRcaIntegrationServicesCoreCorePart8Integration:
    ...
    def test_cross_module_integration(self):
        ...
        with patch(
            "src.beast_mode.testing.rca_integration_services_core_core_part_8.dependent_module"
        ) as mock_dep:
