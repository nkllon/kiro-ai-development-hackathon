...
from src.beast_mode.testing.rca_integration_services_core_core_part_31 import (
    RcaIntegrationServicesCoreCorePart31,
)
...
class TestRcaIntegrationServicesCoreCorePart31Integration:
    ...
    def test_cross_module_integration(self):
        ...
        with patch(
            "src.beast_mode.testing.rca_integration_services_core_core_part_31.dependent_module"
        ) as mock_dep:
