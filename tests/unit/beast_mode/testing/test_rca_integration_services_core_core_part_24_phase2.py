...
from src.beast_mode.testing.rca_integration_services_core_core_part_24 import (
    RcaIntegrationServicesCoreCorePart24,
)
...
class TestRcaIntegrationServicesCoreCorePart24Integration:
    ...
    def test_cross_module_integration(self):
        ...
        with patch(
            "src.beast_mode.testing.rca_integration_services_core_core_part_24.dependent_module"
        ) as mock_dep:
