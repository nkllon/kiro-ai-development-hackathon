...
from src.beast_mode.testing.rca_integration_services_core_core_part_10 import (
    RcaIntegrationServicesCoreCorePart10,
)
...
class TestRcaIntegrationServicesCoreCorePart10Integration:
    ...
    def test_cross_module_integration(self):
        ...
        with patch(
            "src.beast_mode.testing.rca_integration_services_core_core_part_10.dependent_module"
        ) as mock_dep:
