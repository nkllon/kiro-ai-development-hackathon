...
from src.beast_mode.testing.rca_integration_services_services_core_part_31 import (
    RcaIntegrationServicesServicesCorePart31,
)
...
class TestRcaIntegrationServicesServicesCorePart31Integration:
    ...
    def test_cross_module_integration(self):
        ...
        with patch(
            "src.beast_mode.testing.rca_integration_services_services_core_part_31.dependent_module"
        ) as mock_dep:
