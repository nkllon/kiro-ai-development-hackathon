...
from src.beast_mode.testing.rca_integration_services_core_core_part_35 import (
    RcaIntegrationServicesCoreCorePart35,
)
...
class TestRcaIntegrationServicesCoreCorePart35Integration:
    ...
    def test_cross_module_integration(self):
        ...
        with patch(
            "src.beast_mode.testing.rca_integration_services_core_core_part_35.dependent_module"
        ) as mock_dep:
