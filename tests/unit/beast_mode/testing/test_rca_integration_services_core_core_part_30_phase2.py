...
from src.beast_mode.testing.rca_integration_services_core_core_part_30 import (
    RcaIntegrationServicesCoreCorePart30,
)
...
class TestRcaIntegrationServicesCoreCorePart30Integration:
    ...
    def test_cross_module_integration(self):
        ...
        with patch(
            "src.beast_mode.testing.rca_integration_services_core_core_part_30.dependent_module"
        ) as mock_dep:
