...
from src.beast_mode.testing.rca_integration_services_services_validation import (
...
class TestRcaIntegrationServicesServicesValidationIntegration:
    ...
    def test_cross_module_integration(self):
        ...
        with patch(
            "src.beast_mode.testing.rca_integration_services_services_validation.dependent_module"
        ) as mock_dep:
