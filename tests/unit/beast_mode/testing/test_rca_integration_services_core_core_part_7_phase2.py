...
from src.beast_mode.testing.rca_integration_services_core_core_part_7 import (
    RcaIntegrationServicesCoreCorePart7,
)
...
class TestRcaIntegrationServicesCoreCorePart7Integration:
    ...
    def test_cross_module_integration(self):
        ...
        with patch(
            "src.beast_mode.testing.rca_integration_services_core_core_part_7.dependent_module"
        ) as mock_dep:
