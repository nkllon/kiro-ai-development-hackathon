...
from src.beast_mode.testing.rca_integration_services_core_core_part_21 import (
    RcaIntegrationServicesCoreCorePart21,
)
...
class TestRcaIntegrationServicesCoreCorePart21Integration:
    ...
    def test_cross_module_integration(self):
        ...
        with patch(
            "src.beast_mode.testing.rca_integration_services_core_core_part_21.dependent_module"
        ) as mock_dep:
