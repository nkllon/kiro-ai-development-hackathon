...
from src.beast_mode.testing.rca_integration_services_core_core_part_11 import (
    RcaIntegrationServicesCoreCorePart11,
)
...
class TestRcaIntegrationServicesCoreCorePart11Integration:
    ...
    def test_cross_module_integration(self):
        ...
        with patch(
            "src.beast_mode.testing.rca_integration_services_core_core_part_11.dependent_module"
        ) as mock_dep:
