...
Priority: CRITICAL
Module: beast_mode.testing.performance_monitor_core_core_validation
...
from src.beast_mode.testing.performance_monitor_core_core_validation import (
    PerformanceMonitorCoreCoreValidation,
)


class TestPerformanceMonitorCoreCoreValidationPerformance:
    """Performance tests for PerformanceMonitorCoreCoreValidation."""

    def setup_method(self):
        """Set up performance test fixtures."""
        self.instance = PerformanceMonitorCoreCoreValidation()
