...
from src.beast_mode.testing.rca_integration_services_core_core_part_41 import (
    RcaIntegrationServicesCoreCorePart41,
)
...
class TestRcaIntegrationServicesCoreCorePart41Integration:
    ...
    def test_cross_module_integration(self):
        ...
        with patch(
            "src.beast_mode.testing.rca_integration_services_core_core_part_41.dependent_module"
        ) as mock_dep:
