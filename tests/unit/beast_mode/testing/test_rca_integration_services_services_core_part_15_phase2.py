...
from src.beast_mode.testing.rca_integration_services_services_core_part_15 import (
    RcaIntegrationServicesServicesCorePart15,
)
...
class TestRcaIntegrationServicesServicesCorePart15Integration:
    ...
    def test_cross_module_integration(self):
        ...
        with patch(
            "src.beast_mode.testing.rca_integration_services_services_core_part_15.dependent_module"
        ) as mock_dep:
