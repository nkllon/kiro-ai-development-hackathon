...
from src.beast_mode.testing.rca_integration_services_core_core_part_25 import (
    RcaIntegrationServicesCoreCorePart25,
)
...
class TestRcaIntegrationServicesCoreCorePart25Integration:
    ...
    def test_cross_module_integration(self):
        ...
        with patch(
            "src.beast_mode.testing.rca_integration_services_core_core_part_25.dependent_module"
        ) as mock_dep:
