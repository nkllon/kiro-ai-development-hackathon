...
from src.beast_mode.testing.rca_integration_services_core_core_part_15 import (
    RcaIntegrationServicesCoreCorePart15,
)
...
class TestRcaIntegrationServicesCoreCorePart15Integration:
    ...
    def test_cross_module_integration(self):
        ...
        with patch(
            "src.beast_mode.testing.rca_integration_services_core_core_part_15.dependent_module"
        ) as mock_dep:
