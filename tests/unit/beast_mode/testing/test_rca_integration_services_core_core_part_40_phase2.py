...
from src.beast_mode.testing.rca_integration_services_core_core_part_40 import (
    RcaIntegrationServicesCoreCorePart40,
)
...
class TestRcaIntegrationServicesCoreCorePart40Integration:
    ...
    def test_cross_module_integration(self):
        ...
        with patch(
            "src.beast_mode.testing.rca_integration_services_core_core_part_40.dependent_module"
        ) as mock_dep:
