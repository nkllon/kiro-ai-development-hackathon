...
Enhanced: 2025-09-14T06:30:15.504156
"""
...
class TestConfigManager:
    ...
    def test_validate_invalid_config(self):
        ...
        assert any(
            "Agent must have at least one capability" in issue for issue in issues
        )
        assert any(
            "Health check interval must be positive" in issue for issue in issues
        )
