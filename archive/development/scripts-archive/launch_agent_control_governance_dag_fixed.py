#!/usr/bin/env python3
"""
Agent Control Governance DAG Launcher - FIXED VERSION
====================================================
...
try:
    from src.dag_orchestration.core.dag_orchestrator import DAGOrchestrator, TaskDefinition
...
class AgentControlGovernanceDAGLauncher(ReflectiveModule):
    ...
    def get_module_info(self) -> Dict[str, Any]:
        ...
        return {
            "module_id": "agent_control_governance_dag_launcher_fixed",
            "name": "Agent Control Governance DAG Launcher Fixed",
            "version": "1.0.1",
            "description": "Launches Agent Control Governance implementation with DAG orchestration - FIXED",
            "author": "Beast Mode Framework"
        }
    ...
    async def launch_parallel_execution(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # Convert task definitions to TaskDefinition objects
            task_objects = []
            for task_def in self.task_definitions:
                task_obj = TaskDefinition(
                    ...
                    execution_context=task_def.get('execution_context', {})
                )
...
async def main():
    ...
    logger.info("🚀 AGENT CONTROL GOVERNANCE DAG LAUNCHER - FIXED VERSION")
    logger.info("=" * 60)
    ...
    # Save results
    results_file = "agent_control_governance_execution_results_fixed.json"
