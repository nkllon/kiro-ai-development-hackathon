...
**The Requirements ARE the Solution - and we have the evidence to prove it!**""",
    ...
    result = fill_form_field(
        'textarea[name="submission[description]"]', project_data["description"]
    )
    if result is None:
    ...
    result = fill_form_field(
        'input[name="submission[project_url]"]', project_data["project_url"]
    )
    if result is None:
    ...
    result = fill_form_field(
        'input[name="submission[demo_video_url]"]', project_data["demo_video"]
    )
    if result is None:
