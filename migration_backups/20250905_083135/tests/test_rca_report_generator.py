...
class TestRCAReportGenerator:
    ...
    def sample_rca_result(self, sample_test_failure):
        ...
        systematic_fix = SystematicFix(
            ...
            validation_criteria=["Package is installed", "Tests pass without errors"],
    ...
    def test_format_for_console(self, report_generator, sample_rca_report):
        ...
        console_output = report_generator.format_for_console(
            sample_rca_report, use_colors=False
        )
    ...
    def test_format_for_console_with_colors(self, report_generator, sample_rca_report):
        ...
        console_output = report_generator.format_for_console(
            sample_rca_report, use_colors=True
        )
    ...
    def test_report_configuration_defaults(self):
        ...
        assert len(config.include_sections) == len(
            list(ReportSection)
    ...
    def test_report_with_multiple_failures(
        self, report_generator, sample_test_failure, sample_rca_result
    ):
    ...
    def test_save_report_to_file(
        self, mock_open, mock_mkdir, report_generator, sample_rca_report
    ):
        ...
        config = ReportConfiguration(
            format=ReportFormat.MARKDOWN, output_file="reports/test_report.md"
        )
    ...
    def test_error_handling_in_section_generation(
        self, report_generator, sample_rca_report
    ):
    ...
    def test_report_metadata_accuracy(self, report_generator, sample_rca_report):
        ...
        assert (
            metadata["systematic_fixes"]
            == sample_rca_report.summary.systematic_fixes_available
        )
        assert (
            metadata["confidence_score"] == sample_rca_report.summary.confidence_score
        )
    ...
    def test_different_format_consistency(self, report_generator, sample_rca_report):
        ...
        assert (
            json_data["analysis_summary"]["total_failures"]
            == sample_rca_report.total_failures
        )
