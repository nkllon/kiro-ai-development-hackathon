...
from src.spec_reconciliation.governance import GovernanceController, SpecProposal
...
class TestTerminologyRegressionPrevention:
    ...
    def test_prevent_rca_terminology_regression(self):
        ...
        has_issues = (
            ...
            or regression_report.consistency_score < 0.9
        )
    ...
    def test_prevent_compound_terminology_regression(self):
        ...
        total_issues = len(regression_report.inconsistent_terms) + len(
            regression_report.new_terms
        )
...
class TestFunctionalOverlapRegressionPrevention:
    ...
    def test_prevent_cross_domain_overlap_regression(self):
        ...
        assert (
            validation_result == self.governance.ValidationResult.REQUIRES_CONSOLIDATION
        )
...
class TestArchitecturalDecisionRegressionPrevention:
    ...
    def test_prevent_reflective_module_decision_regression(self):
        ...
        validation_result = self.monitor.validate_architectural_decisions(
            violating_decision
        )
...
class TestQualityMetricsRegressionPrevention:
    ...
    def test_prevent_terminology_consistency_regression(self):
        ...
        assert (
            ...
            >= self.quality_baselines["terminology_consistency"]
        )
        ...
        if (
            regression_report.consistency_score
            < self.quality_baselines["terminology_consistency"]
        ):
