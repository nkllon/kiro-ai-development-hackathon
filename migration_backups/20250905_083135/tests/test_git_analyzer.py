...
class TestGitAnalyzer:
    ...
    def test_get_commits_ahead_of_main_success(self, mock_run, git_analyzer):
        ...
        show_result1.stdout = (
            "commit1|Author1|1640995200|First commit\nA\tsrc/file1.py\n"
        )
        ...
        show_result2.stdout = (
            "commit2|Author2|1640995300|Second commit\nM\tsrc/file2.py\n"
        )
        ...
        show_result3.stdout = (
            "commit3|Author3|1640995400|Third commit\nD\tsrc/file3.py\n"
        )
    ...
    def test_analyze_file_changes_with_commits(self, git_analyzer, mock_commit_info):
        ...
        with patch.object(
            git_analyzer, "_get_commit_line_changes", return_value=(10, 5)
        ):
    ...
    def test_map_changes_to_tasks_default_patterns(self, git_analyzer):
        ...
        assert (
            "src/beast_mode/compliance/git/new_analyzer.py"
            in task_mapping["git_analysis"]
        )
    ...
    def test_map_changes_to_tasks_custom_patterns(self, git_analyzer):
        ...
        custom_patterns = {"custom_task": ["custom/*"]}
    ...
    def test_analyze_method(self, git_analyzer):
        ...
        context = {"target_branch": "feature-branch", "base_branch": "main"}
    ...
    def test_analyze_method_with_error(self, git_analyzer):
        ...
        with patch.object(
            ...
            assert (
                result.critical_issues[0].issue_type
    ...
    def test_file_matches_pattern(self, git_analyzer):
        ...
        assert (
            git_analyzer._file_matches_pattern(
...
class TestGitAnalyzerIntegration:
    ...
    def test_real_git_operations(self, real_git_repo):
        ...
        subprocess.run(
            ["git", "commit", "-m", "Add test file"], cwd=real_git_repo, check=True
        )
