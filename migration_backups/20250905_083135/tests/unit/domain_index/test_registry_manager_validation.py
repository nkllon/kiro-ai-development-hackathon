...
class TestRegistryManagerValidation:
    ...
    def test_validate_domain_uses_comprehensive_validator(self, registry_manager):
        ...
        # Mock the validator
        registry_manager._validator.validate_domain = Mock(
    ...
    def test_validate_all_domains(self, registry_manager):
        ...
        # Mock the validator
        registry_manager._validator.validate_domain_collection = Mock(
            return_value={
    ...
    def test_check_domain_consistency(self, registry_manager):
        ...
        registry_manager._validator.check_consistency = Mock(
    ...
    def test_detect_circular_dependencies(self, registry_manager):
        ...
        registry_manager._validator.detect_circular_dependencies = Mock(
    ...
    def test_validate_domain_dependencies(self, registry_manager):
        ...
        registry_manager._validator.validate_dependencies = Mock(
            return_value=expected_issues
        )
    ...
    def test_get_validation_stats(self, registry_manager):
        ...
        registry_manager._validator.get_validation_stats = Mock(
    ...
    def test_registry_stats_include_validation(self, registry_manager):
        ...
        registry_manager._validator.get_validation_stats = Mock(
            return_value={"validations_performed": 3}
        )
    ...
    def test_domain_update_with_validation(self, registry_manager):
        ...
        if result:  # Only check if update succeeded
            ...
            assert (
                registry_manager._domains["update_test"].description
                == "Updated description"
            )
...
class TestValidationIntegration:
    ...
    def test_complete_validation_workflow(self):
        ...
        try:
            ...
            config = {
                "validator": {"strict_validation": False, "check_filesystem": False}
            }
            ...
            with patch(
                ...
                assert (
                    final_stats["validation_rules_count"]
                    > stats["validation_rules_count"]
                )
