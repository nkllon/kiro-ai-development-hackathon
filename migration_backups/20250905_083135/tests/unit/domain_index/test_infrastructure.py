...
from src.beast_mode.domain_index.config import (
    DomainIndexConfig,
    get_config,
    reset_config,
)
...
class TestDomainIndexConfig:
    ...
    def test_environment_config(self):
        ...
        assert test_config.get("registry_path").endswith(
            "test_project_model_registry.json"
        )
    ...
    def test_config_validation(self):
        ...
        config = DomainIndexConfig(
            "test"
        )  # Use test config to avoid file existence checks
...
class TestDomainIndexExceptions:
    ...
    def test_domain_index_error(self):
        ...
        assert (
            str(error)
            == "Test error | Component: test_component | Operation: test_operation"
        )
