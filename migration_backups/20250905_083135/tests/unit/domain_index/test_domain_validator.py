...
class TestValidationRule:
    ...
    def test_validation_rule_execution(self):
        ...
        valid_domain = Domain(
            "test", "Test domain", ["src/**/*.py"], [], [], [], tools, metadata
        )
        ...
        invalid_domain = Domain(
            "", "Test domain", ["src/**/*.py"], [], [], [], tools, metadata
        )
...
class TestConsistencyCheck:
    ...
    def test_consistency_check_execution(self):
        ...
        domain2 = Domain(
            "domain2", "Domain 2", ["src/2/**/*.py"], [], [], [], tools, metadata
        )
...
class TestDomainValidator:
    ...
    def test_validate_invalid_domain_name(self, validator):
        ...
        # Invalid name format
        domain = Domain(
            "Test-Domain!", "Test domain", ["src/**/*.py"], [], [], [], tools, metadata
        )
        result = validator.validate_domain(domain)
    ...
    def test_validate_domain_collection(self, validator):
        ...
        assert (
            results["valid_domain"].is_valid or len(results["valid_domain"].errors) == 0
        )
    ...
    def test_validate_dependencies(self, validator):
        ...
        domain_b = Domain(
            "domain_b", "Domain B", ["src/b/**/*.py"], [], [], [], tools, metadata
        )
    ...
    def test_add_custom_consistency_check(self, validator):
        ...
        domains = {
            "single": Domain(
                "single", "Single domain", ["src/**/*.py"], [], [], [], tools, metadata
            )
        }
    ...
    def test_validation_statistics(self, validator, sample_domain):
        ...
        assert (
            final_stats["validations_performed"]
            > initial_stats["validations_performed"]
        )
        assert (
            final_stats["consistency_checks_performed"]
            > initial_stats["consistency_checks_performed"]
        )
...
class TestValidatorIntegration:
    ...
    def test_full_validation_workflow(self):
        ...
        assert (
            validation_results["valid_domain"].is_valid
            or len(validation_results["valid_domain"].errors) == 0
        )
