...
"""
    ...
    def test_parse_code_block(self, validator, temp_repo):
        ...
        components = validator._parse_code_block(
            code_lines, temp_repo / "design.md", 10
        )
...
"""
    ...
    def test_analyze_alignment(self, validator):
        ...
        assert (
            len(result.missing_implementations) >= 0
        )  # GitAnalyzer is missing analyze_file_changes
    ...
    def test_generate_alignment_issues(self, validator):
        ...
        issues = validator._generate_alignment_issues(
            missing_impl, extra_impl, misaligned, score
        )
...
'''
    ...
    def test_alignment_score_calculation(self, validator):
        ...
        if result.total_design_components > 0:
            expected_score = (
                result.implemented_components / result.total_design_components * 100
            )
