    ...
    for i, test_failure in enumerate(test_failures):
        ...
        failure = Failure(
            ...
            category=(
                ...
                if "ImportError" in test_failure.error_message
                    ...
                    if "FileNotFoundError" in test_failure.error_message
        ...
        if "ImportError" in test_failure.error_message:
            ...
            root_cause = RootCause(
                ...
                evidence=[
                    "FileNotFoundError in test execution",
        ...
        systematic_fix = SystematicFix(
            ...
            estimated_time_minutes=(
                15 if "ImportError" in test_failure.error_message else 10
            ),
        )
...
def create_sample_rca_report():
    ...
    summary = TestRCASummaryData(
        ...
        critical_issues=[
            "Missing critical configuration file",
            "Broken dependency blocking tests",
        ],
    )
...
def demo_console_report():
    ...
    print(
        console_output_plain[:500] + "..."
        if len(console_output_plain) > 500
        else console_output_plain
    )
...
def demo_custom_configurations():
    ...
    print(
        combined_content2[:800] + "..."
        if len(combined_content2) > 800
        else combined_content2
    )
