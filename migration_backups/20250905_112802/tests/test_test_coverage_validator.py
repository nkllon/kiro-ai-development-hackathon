...
"""
    ...
    def test_find_test_files(self, validator, temp_repo):
        ...
        module1_test = next(
            tf for tf in test_files if "test_module1.py" in tf.file_path
        )
            ...
            "tests": [
                {
                    ...
                    "outcome": "failed",
                    "call": {"longrepr": "AssertionError: Intentional failure"},
                },
                {
    ...
    def test_analyze_coverage(self, validator):
        ...
        assert (
            len(result.issues) >= 4
        )  # Coverage, failing tests, missing files, uncovered modules
    ...
    def test_generate_coverage_issues(self, validator):
        ...
        assert all(
            issue_type == ComplianceIssueType.TEST_FAILURE for issue_type in issue_types
        )
    ...
    def test_high_coverage_scenario(self, validator, temp_repo):
        ...
        with patch.object(validator, "_run_coverage_analysis") as mock_coverage:
            mock_coverage.return_value = {
                ...
                "total_lines": 100,
                "covered_lines": 95,
                "file_coverage": {"src/module1.py": {"coverage_percent": 95.0}},
            }
