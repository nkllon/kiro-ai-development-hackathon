...
class TestDocumentManagementRM:
    ...
    def test_rm_documentation_constraint_enforcement(
        self, doc_manager, sample_rdi_document
    ):
        """Test RM documentation constraint enforcement"""
        # Test RM without documentation
        constraint_result = doc_manager.enforce_rm_documentation_constraint(
            "unregistered_rm"
        )
    ...
    def test_rdi_document_template_creation(self, doc_manager):
        ...
        result = doc_manager.create_rdi_document_template(
            "test_rm", DocumentType.REQUIREMENTS, "Test RM Requirements"
        )
    ...
    def test_cross_reference_validation(self, doc_manager, sample_rdi_document):
        ...
        # Register document
        doc_manager.document_registry[sample_rdi_document.document_id] = (
            sample_rdi_document
        )

        # Validate cross-references
        validation_result = doc_manager.validate_cross_references(
            sample_rdi_document.document_id
        )
...
class TestReflectiveModuleDocumentationConstraint:
    ...
    def test_rm_template_creation_integration(self, temp_project_root):
        ...
        template_result = test_rm.create_rm_documentation_template(
            "requirements", "Test RM Requirements"
        )
