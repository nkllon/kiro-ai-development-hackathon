...
class TestRCAEngineTestSpecificAnalysis:
    ...
    def test_pytest_failure_categorization(self):
        ...
        # Test categorization
        categorization = self.rca_engine.analyze_test_failure_categorization(
            pytest_failure
        )
    ...
    def test_test_specific_systematic_fix_generation(self):
        ...
        fixes = self.rca_engine.generate_test_specific_systematic_fixes(
            [test_root_cause]
        )
    ...
    def test_pattern_matching_performance(self):
        ...
        for i in range(100):
            ...
            pattern = PreventionPattern(
                ...
                failure_signature=self.rca_engine._generate_test_failure_signature(
                    test_failure
                ),
        ...
        assert (
            match_time < 1.0
        ), f"Pattern matching took {match_time:.3f}s, should be < 1.0s"
    ...
    def test_pytest_specific_analysis_methods(self, mock_subprocess):
        ...
        mock_subprocess.return_value = Mock(
            returncode=0, stdout="pytest 6.2.4", stderr=""
        )
    ...
    def test_makefile_specific_analysis_methods(self, mock_subprocess):
        ...
        # Mock subprocess calls
        mock_subprocess.return_value = Mock(
            returncode=0, stdout="make help output", stderr=""
        )
    ...
    def test_test_specific_root_cause_identification(self):
        ...
        root_causes = self.rca_engine._identify_root_causes(
            test_failure, analysis_result
        )

        # Should identify test-specific root causes
        test_specific_causes = [
            rc
