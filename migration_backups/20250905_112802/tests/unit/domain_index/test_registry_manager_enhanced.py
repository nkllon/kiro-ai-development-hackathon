...
class TestEnhancedRegistryManager:
    ...
    def sample_registry_data(self):
        ...
        return {
            "domain_architecture": {
                ...
                "api": {"description": "API layer domains", "domains": []},
            }
        }
    ...
    def registry_manager(self, temp_registry_file):
        ...
        config = {
            "cache": {"max_cache_size": 100, "default_ttl_seconds": 300},
            "index": {"enable_fuzzy_search": True, "min_query_length": 2},
        }

        with patch(
            "src.beast_mode.domain_index.registry_manager.get_config"
        ) as mock_config:
    ...
    def test_get_domain_uses_cache(self, registry_manager):
        ...
        try:
            ...
            registry_manager._domain_cache.get_domain.assert_called_with(
                "user_management"
            )
    ...
    def test_update_domain_updates_index(self, registry_manager):
        ...
        metadata = DomainMetadata(
            "core", "yes", PackagePotential(0.8, [], [], "medium", [])
        )
        domain = Domain(
            "test_domain",
            "Test domain",
        ...
        if result:  # Only check if update succeeded
            ...
            registry_manager._domain_cache.invalidate_domain.assert_called_with(
                "test_domain"
            )
    ...
    def test_get_registry_stats_includes_cache_and_index(self, registry_manager):
        ...
        registry_manager._index.get_index_stats = Mock(
            return_value={"indexed_domains": 5}
        )
    ...
    def test_search_suggestions(self, registry_manager):
        ...
        registry_manager._index.suggest_completions = Mock(
            return_value=["user", "user_management"]
        )
    ...
    def test_search_by_pattern(self, registry_manager):
        ...
        registry_manager._index.search_by_pattern = Mock(
            return_value=["user_management"]
        )
    ...
    def test_search_by_category(self, registry_manager):
        ...
        registry_manager._index.search_by_category = Mock(
            return_value=["user_management"]
        )
    ...
    def test_get_domain_relationships(self, registry_manager):
        ...
        registry_manager._index.get_domain_relationships = Mock(
        ...
        registry_manager._index.get_domain_relationships.assert_called_with(
            "user_management"
        )
    ...
    def test_get_cache_info(self, registry_manager):
        ...
        registry_manager._cache.get_entry_info.assert_called_with(
    ...
    def test_error_handling_with_caching_and_indexing(self, registry_manager):
        ...
        # Mock cache failure
        registry_manager._domain_cache.cache_domain = Mock(
    ...
    def test_full_workflow_with_caching_and_indexing(self):
        ...
        registry_data = {
            "domain_architecture": {
                ...
                "api": {"description": "API domains", "domains": ["rest_api"]},
            }
        }
