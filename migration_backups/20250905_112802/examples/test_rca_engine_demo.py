...
def demo_pytest_failure_analysis():
    ...
    print(
        f"Categorization: {categorization['primary_category']}/{categorization['subcategory']}"
    )
...
def demo_integration_with_existing_rca():
    ...
    print(
        f"- Test-specific components added: {'✓' if 'test_specific' in rca_engine.analysis_components else '✗'}"
    )
