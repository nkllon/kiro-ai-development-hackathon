...
async def demo_unified_client():
    ...
    try:
        ...
        print(
            f"   Transport Features: {list(capabilities['transport_capabilities'].keys())}"
        )
        ...
        await client.request_help(
            "unified_client_demo", "Testing the new unified client"
        )
        ...
        try:
            ...
            if success:
                ...
                await client.broadcast_message(
                    f"Hello from {transport_type} transport!"
                )
