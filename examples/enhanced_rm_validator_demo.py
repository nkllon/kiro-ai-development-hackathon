...
'''
    ...
    for class_num in range(2, 8):
        bad_module_lines.extend(
            [f"class Class{class_num}:", f"    def method(self): pass", ""]
        )
...
def demonstrate_architectural_validation():
    ...
    try:
        ...
        print(
            f"   🎯 Single responsibility score: {good_result.single_responsibility_score:.2f}"
        )
        ...
        print(
            f"   🎯 Single responsibility score: {bad_result.single_responsibility_score:.2f}"
        )
        ...
        print(
            f"   📋 Overall compliance score: {comprehensive_result.compliance_score:.2f}"
        )
        print(
            f"   🔌 Interface implemented: {comprehensive_result.interface_implemented}"
        )
        print(
            f"   📏 Size constraints met: {comprehensive_result.size_constraints_met}"
        )
        print(
            f"   💓 Health monitoring present: {comprehensive_result.health_monitoring_present}"
        )
        print(f"   📝 Registry integrated: {comprehensive_result.registry_integrated}")

        critical_issues = [
            issue
            for issue in comprehensive_result.issues
