...
class AdaptiveNavigator:
    ...
    def _discover_general_patterns(self, page) -> List[LearningPattern]:
        ...
        try:
            ...
            for link in links:
                ...
                if any(
                    word in href.lower()
                    for word in ["next", "continue", "step", "forward"]
                ):
                    patterns.append(
                        LearningPattern(
                            "link_forward",
    ...
    def _discover_context_patterns(self, page) -> List[LearningPattern]:
        ...
        try:
            ...
            if "form" in title or "edit" in url:
                form_buttons = page.query_selector_all(
                ...
                if step_indicators:
                    patterns.append(
                        LearningPattern(
                            ...
                            0.7,
                            context={
                                "type": "step_indicators",
                                "page_context": "multi_step",
                            },
                        )
                    )
        ...
        for new_pattern in new_patterns:
            ...
            for existing_pattern in self.learned_patterns:
                if (
                    ...
                    and existing_pattern.selector == new_pattern.selector
                ):
    ...
    def _analyze_element_with_learned_patterns(
        self, element, element_type: str, page
    ) -> Dict[str, Any]:
                ...
                try:
                    if self._element_matches_pattern(element, pattern):
                        ...
                        analysis["reasoning"].append(
                            f"Matches learned pattern: {pattern.pattern_type}"
                        )
    ...
    def _heuristic_analysis(self, element, element_type: str, page) -> Dict[str, Any]:
        ...
        analysis = {"confidence": 0.0, "action": "unknown", "reasoning": []}
    ...
    def _adaptive_navigation_loop(self):
        ...
        while navigation_count < max_navigations:
            ...
            for element, element_type in all_elements:
                try:
                    analysis = self._analyze_element_with_learned_patterns(
                        element, element_type, self.page
                    )
    ...
    def _make_adaptive_decision(self, element_analyses):
        ...
        if high_confidence:
            ...
            print(
                f"✅ High confidence decision: {best['text']} (confidence: {best['confidence']:.2f})"
            )
        ...
        medium_confidence = [
            e for e in element_analyses if 0.4 <= e["confidence"] < 0.7
        ]
