...
class NotificationSettings(ReflectiveModule):
    ...
    def __init__(self, settings_data: Dict[str, Any] = None):
        ...
        self.quiet_hours = self.settings_data.get(
    ...
    def get_module_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "timing": (
                self.timing.value if hasattr(self.timing, "value") else str(self.timing)
            ),
    ...
    def get_capabilities(self) -> List[ModuleCapability]:
        ...
        return [
            ModuleCapability.SETTINGS_MANAGEMENT,
            ModuleCapability.TIMING_CONTROL,
            ModuleCapability.CHANNEL_MANAGEMENT,
            ModuleCapability.PREFERENCE_CONTROL,
        ]
...
class NotificationMessage(ReflectiveModule):
    ...
    def get_capabilities(self) -> List[ModuleCapability]:
        """Get module capabilities."""
        return [
            ModuleCapability.MESSAGE_MANAGEMENT,
            ModuleCapability.DELIVERY_TRACKING,
            ModuleCapability.RECIPIENT_MANAGEMENT,
        ]
