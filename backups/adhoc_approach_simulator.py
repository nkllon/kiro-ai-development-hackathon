...
class AdhocApproachSimulator(ReflectiveModule):
    ...
    def simulate_adhoc_decision_making(
        ...
        try:
            ...
            if strategy == AdhocDecisionStrategy.RANDOM_CHOICE:
                ...
                success_rate = random.uniform(
                    0.4, 0.7
                )  # Moderate success (experience helps)
                ...
                success_rate = random.uniform(
                    0.1, 0.3
                )  # Very low success (context mismatch)
    ...
    def simulate_adhoc_problem_solving(
    ...
    def simulate_adhoc_tool_management(
        ...
        try:
            ...
            accepts_broken_tools = random.choice(
