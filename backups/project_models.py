...
class DevpostProject(ReflectiveModule):
    ...
    def get_capabilities(self) -> List[ModuleCapability]:
        ...
        return [
            ...
            ModuleCapability.TEAM_MANAGEMENT,
            ModuleCapability.SUBMISSION_TRACKING,
    ...
    def remove_team_member(self, member_id: str) -> bool:
        ...
        try:
            self.team_members = [
                m for m in self.team_members if m.get("id") != member_id
            ]
            self._operation_count += 1
            return True
        except Exception as e:
    ...
    def get_project_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "team_member_count": len(self.team_members),
            "submission_deadline": (
                self.submission_deadline.isoformat()
...
class TeamMember(ReflectiveModule):
    ...
    def get_capabilities(self) -> List[ModuleCapability]:
        """Get module capabilities."""
        return [
            ModuleCapability.MEMBER_MANAGEMENT,
            ModuleCapability.ROLE_MANAGEMENT,
            ModuleCapability.PERMISSION_CONTROL,
        ]
