"""
Beast Mode Message Type Compatibility Layer

Provides message type translation between different agent versions, backward compatibility
for older message formats, automatic message type detection and conversion, and graceful
...
class MessageVersion(str, Enum):
    ...
    V2_0 = "2.0"  # Current format with full compatibility layer
    UNKNOWN = "unknown"
