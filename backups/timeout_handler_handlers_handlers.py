"""
Timeout Handler Handlers Handlers

This module was extracted from timeout_handler_handlers.py
...
class RCATimeoutHandler(ReflectiveModule):
    ...
    def __init__(self, timeout_config: Optional[TimeoutConfiguration] = None):
        ...
        self.degradation_strategies = {
            1: self._apply_level_1_degradation,
            2: self._apply_level_2_degradation,
            3: self._apply_level_3_degradation,
        }
