...
class SyncResult(ReflectiveModule):
    ...
    def get_capabilities(self) -> List[ModuleCapability]:
        ...
        return [
            ModuleCapability.RESULT_TRACKING,
...
class FileChangeEvent(ReflectiveModule):
    ...
    def __init__(self, event_data: Dict[str, Any] = None):
        ...
        self.change_type = (
            change_type_value
            if isinstance(change_type_value, ChangeType)
            else ChangeType(change_type_value)
        )
    ...
    def get_capabilities(self) -> List[ModuleCapability]:
        ...
        return [
            ...
            ModuleCapability.CHANGE_DETECTION,
