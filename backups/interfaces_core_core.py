...
This module was extracted from interfaces_core.py
...
class RealityChecker(ABC):
    ...
    @abstractmethod
    def require_accountability_verification(
        self, actor_id: str, decision: Decision
    ) -> VerificationRequirement:
        """
...
class CorruptionPreventer(ABC):
    ...
    @abstractmethod
    def implement_emergency_intervention(
        self, corruption_indicators: dict
    ) -> GovernanceIntervention:
