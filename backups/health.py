...
class DomainHealth:
    ...
    def is_healthy(self) -> bool:
        ...
        return (
            self.boundary_integrity and
            self.invariant_compliance and
            self.language_consistency > 0.8 and
...
class HealthMonitor:
    ...
    async def get_health_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "domain_health": current_health.domain_health.to_dict() if current_health.domain_health else None,
