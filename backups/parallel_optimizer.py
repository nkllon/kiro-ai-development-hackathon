...
class ParallelOptimizer:
    ...
    def _identify_resource_based_opportunities(
        ...
        # Create opportunities for compatible resource groups
    ...
    def _identify_skill_based_opportunities(
        ...
        # Create opportunities for skill-based groups
    ...
    def _sort_groups_by_dependencies(
        ...
        # Simple topological sort based on task dependencies
        return sorted(
            groups,
            key=lambda g: min(
