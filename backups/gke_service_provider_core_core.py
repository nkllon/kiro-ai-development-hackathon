"""
Gke Service Provider Core Core

This module was extracted from gke_service_provider_core.py
...
def _analyze_systematic_adoption_trends(self) -> Dict[str, Any]:
    ...
    adoption_scores = [
        metrics.systematic_adoption_score for metrics in self.gke_team_metrics.values()
    ]
    return {
