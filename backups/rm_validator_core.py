...
class RMValidator:
    ...
    def validate_rm_interface_implementation(
        ...
        try:
            ...
            interface_compliance_score = (
                implemented_required / total_required if total_required > 0 else 0.0
            )
    ...
    def check_size_constraints(self, module_path: str) -> SizeConstraintResult:
        ...
        try:
            ...
            self._check_architectural_patterns(
                module_path, complexity_indicators, issues
            )
    ...
    def validate_health_monitoring(self, module_path: str) -> HealthMonitoringResult:
        ...
        try:
            ...
            has_critical_health_methods = (
                "is_healthy" in method_names and "get_health_indicators" in method_names
            )
            ...
            health_monitoring_score = (
                implemented_health_methods / total_health_methods
                if total_health_methods > 0
                else 0.0
            )
    ...
    def _calculate_single_responsibility_score(
