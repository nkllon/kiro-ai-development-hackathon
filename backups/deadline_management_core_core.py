"""
Deadline Management Core Core

This module was extracted from deadline_management_core.py
    ...
    try:
        ...
        for task in self.tasks:
            ...
            if (
                ...
                task.priority == TaskPriority.MEDIUM and task.technical_debt_risk > 0.7
            ):
