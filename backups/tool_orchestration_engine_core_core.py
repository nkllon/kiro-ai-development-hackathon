"""
Tool Orchestration Engine Core Core

This module was extracted from tool_orchestration_engine_core.py
...
def get_health_indicators(self) -> Dict[str, Any]:
    ...
    return {
        "orchestration_status": {
            ...
            "failed_tools": len(
                [t for t in self.tool_health_cache.values() if t == ToolStatus.FAILED]
            ),
            "success_rate": self._calculate_success_rate(),
        },
        "decision_framework": {
...
def _make_medium_confidence_decision(
    ...
    perspective_analysis = (
        self.multi_perspective_engine.analyze_decision_with_stakeholder_perspectives(
...
def get_decision_framework_status(self) -> Dict[str, Any]:
    ...
    return {
        ...
        "rca_integration": {
            ...
            "rca_engine_healthy": (
                self.rca_engine.is_healthy() if hasattr(self, "rca_engine") else False
            ),
        },
        "adaptive_patterns": {
