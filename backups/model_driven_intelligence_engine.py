...
class ModelDrivenIntelligenceEngine(ReflectiveModule):
    ...
    def get_health_indicators(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "analysis_performance": {
                "status": (
                    "healthy"
                    if self.performance_metrics["successful_analyses"]
    ...
    def analyze_with_model(
        self, model_type: ModelType, context: Dict[str, Any]
    ) -> ModelAnalysis:
    ...
    def _create_failed_analysis(
        self, model_type: ModelType, error: str
    ) -> ModelAnalysis:
    ...
    def _update_performance_metrics(self, analysis: ModelAnalysis):
        ...
        self.performance_metrics["average_confidence_score"] = (
            total_confidence / self.performance_metrics["total_analyses"]
        )
    ...
    def get_model_performance_report(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "model_types_used": list(
                set(analysis.model_type.value for analysis in self.analysis_history)
            ),
            "recent_analyses": [
                {
            ...
            "systematic_validation_rate": self.performance_metrics[
                "systematic_validations"
            ]
            / max(1, self.performance_metrics["total_analyses"]),
        }
