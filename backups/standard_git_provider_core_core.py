...
class StandardGitProvider(GitProvider):
    ...
    def stage_files(self, files: List[str]=None) -> GitOperationResult:
        ...
        return self._create_result(success=False, message='stage_files not yet implemented', error_code='NOT_IMPLEMENTED')
    ...
    def resolve_conflict(self, file_path: str, resolution: str) -> GitOperationResult:
        ...
        return self._create_result(success=False, message='resolve_conflict not yet implemented', error_code='NOT_IMPLEMENTED')
