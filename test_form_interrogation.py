...
async def test_form_interrogation_async(submission_url: str):
    ...
    try:
        async with DevPostFormInterrogation(headless=False) as interrogation:
            ...
            # Interrogate the form
            model = await interrogation.interrogate_submission_form_async(submission_url)
...
def main():
    ...
    print("=" * 60)
    print("This test will help you build a complete model of your DevPost submission form.")
