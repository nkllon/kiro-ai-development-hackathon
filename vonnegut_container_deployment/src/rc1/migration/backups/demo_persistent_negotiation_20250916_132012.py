...
def demonstrate_negotiation_scenarios():
    ...
    for i, scenario in enumerate(scenarios, 1):
        ...
        if "Clear Direction" in scenario["name"]:
            print(
                f"   🤖 AI Response: 'Clear direction received! Executing your choice...'"
            )
            ...
            print(
                f"   🤖 AI Response: 'Human counterparty disconnected. Terminal failure mode.'"
            )
            print(
                f"   🤖 AI Response: 'I cannot proceed. Preserving session with breadcrumbs.'"
            )
            ...
            print(
                f"   🤖 AI Response: 'Terminal failure mode - cannot proceed without direction.'"
            )
