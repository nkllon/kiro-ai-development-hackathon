        ...
        try:
            ...
            for selector in step_selectors:
                ...
                for elem in elements:
                    ...
                    if (
                        step_text and len(step_text) < 100
                    ):  # Reasonable step text length
                        steps.append(
                            {
                                "text": step_text,
                                "class": step_class,
            ...
            for selector in next_selectors:
                try:
                    ...
                    if element and element.is_visible():
                        print(
                            f"🔄 Clicking next step: {element.text_content().strip()}"
                        )
                        element.click()
        ...
        try:
            ...
            for selector in prev_selectors:
                try:
                    ...
                    if element and element.is_visible():
                        print(
                            f"🔄 Clicking previous step: {element.text_content().strip()}"
                        )
                        element.click()
                        self.page.wait_for_load_state("networkidle")
                        print(f"📄 New page: {self.page.title()}")
