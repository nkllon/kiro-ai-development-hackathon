    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            for selector in form_selectors:
                ...
                if elements:
                    ...
                    for i, element in enumerate(elements[:3]):
                        ...
                        print(f"      {i+1}. <{tag_name.lower()}> id='{element_id}' class='{element_class}' type='{element_type}' name='{element_name}'")
                else:
            ...
            for selector in devpost_selectors:
                elements = page.query_selector_all(selector)
                if elements:
                    print(f"   ✅ Found {len(elements)} DevPost elements with selector: {selector}")
                    ...
                    for i, element in enumerate(elements[:2]):
                        ...
                        print(f"      {i+1}. <{tag_name.lower()}> id='{element_id}' class='{element_class}'")
                        if text_content:
