...
class CriticalTestGenerator:
    ...
    def identify_critical_modules(self) -> List[Dict[str, Any]]:
        ...
        for file_path in critical_gaps:
            ...
            critical_modules.append({
                ...
                "test_priority": self._determine_test_priority(file_path, importance_score)
            })
    ...
    def generate_test_file(self, module_info: Dict[str, Any]) -> str:
        ...
        if category == "core":
            ...
            return self._generate_orchestration_test(module_info, module_file, class_name)
        elif category == "api":
    ...
    def _generate_core_test(self, module_info: Dict[str, Any], module_file: str, class_name: str) -> str:
...
'''
    ...
    def _generate_orchestration_test(self, module_info: Dict[str, Any], module_file: str, class_name: str) -> str:
...
'''
    ...
    def _generate_api_test(self, module_info: Dict[str, Any], module_file: str, class_name: str) -> str:
...
'''
    ...
    def _generate_cli_test(self, module_info: Dict[str, Any], module_file: str, class_name: str) -> str:
...
'''
    ...
    def _generate_general_test(self, module_info: Dict[str, Any], module_file: str, class_name: str) -> str:
...
'''
    ...
    def generate_critical_tests(self, limit: int = 50) -> List[str]:
        ...
        for i, module_info in enumerate(critical_modules[:limit]):
            ...
            print(f"📝 Generating test for {file_path} (Priority: {priority}, Score: {importance_score})")
