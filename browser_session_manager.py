...
class BrowserInstance:
    ...
    def __init__(self, port: int, browser_type: str = "chrome", has_extensions: bool = False):
        self.port = port
...
class BrowserSessionManager:
    ...
    def start_chrome_with_extensions(self, port: int = 9222) -> Optional[BrowserInstance]:
    ...
    def connect_to_browser(self, browser: BrowserInstance) -> Optional[Tuple[Browser, BrowserContext]]:
    ...
    def find_tabs_by_domain(self, browser: BrowserInstance, domain: str) -> List[Dict[str, Any]]:
...
if __name__ == "__main__":
    ...
    if browsers:
        ...
        for browser in browsers:
            ...
            print(f"   Port {browser.port}: {caps['browser_type']} "
