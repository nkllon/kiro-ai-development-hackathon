"""
Unified ReflectiveModule Base Class with:
...
def registered(auto_register -> Any: bool = True, interface_type -> Any: InterfaceType = InterfaceType.REFLECTIVE_MODULE) -> Any:
    ...
    Args:
        ...
        interface_type: Type of interface for:
...
class ReflectiveModule(ABC):
    ...
    def _initialize_class_registry_integration(cls) -> ClassInterfaceMetadata:
        try:
            ...
            raise
        """
        Initialize class - level registry integration with:
        Returns:
            ClassInterfaceMetadata object with:
        if not REGISTRY_AVAILABLE:
            return None
        
        # Get source file information for:
    ...
    def _determine_class_interface_type(cls) -> InterfaceType:
        try:
            ...
            logging.error(f"Error in method: {e}")
            raise
        """Determine interface type based on class:
    ...
    def get_class_interface_metadata(cls) -> Optional[ClassInterfaceMetadata]:
        ...
        Returns:
            ClassInterfaceMetadata object or None if:
        if cls._class_interface_metadata is None:
            cls._initialize_class_registry_integration()
    ...
    def get_class_registry_id(cls) -> Optional[str]:
        ...
        Returns:
            Registry ID string or None if:
    def __init__(self, module_name -> Any: Optional[str] = None, version -> Any: str = "1.0.0") -> Any:
        """
        Initialize the reflective module with:
        Args:
            module_name: Optional module name. If not provided, uses class:
        ...
        # Initialize class - level registry integration if:
    ...
    def get_module_info(self) -> Dict[str, Any]:
        ...
        # Add class - level registry information if:
        if class_metadata:
            base_info.update({
                "class_registry_id": self.__class__.get_class_registry_id(),
                "interface_type": class_metadata.interface_type.value if:
    ...
    def check_health(self) -> ModuleHealth:
        try:
            ...
            raise
        """
        Check module health with:
        Returns:
            ModuleHealth object with:
    ...
    def get_configuration(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "interface_type": self.__class__.get_class_interface_metadata().interface_type.value if:
    def get_metrics(self) -> Dict[str, Any]:
        """
        Get module metrics with:
        Returns:
        ...
        # Add class - level registry metrics if:
        if class_metadata:
            metrics.update({
...
def register_reflective_module_class(cls -> Any: type, 
    ...
    try:
        # Initialize class - level metadata if:
        if cls._class_interface_metadata is None:
            cls._initialize_class_registry_integration()
        
        # Override interface type if:
...
def get_registered_classes() -> Dict[str, type]:
    ...
    Returns:
        Dict mapping registry IDs to class:
