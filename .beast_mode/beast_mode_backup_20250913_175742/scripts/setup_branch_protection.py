...
class BranchProtectionManager:
    ...
    def create_develop_branch(self):
        ...
        master_response = requests.get(
            f"{self.base_url}/git/refs/heads/master", headers=self.headers
        )
        ...
        develop_response = requests.get(
            f"{self.base_url}/git/refs/heads/develop", headers=self.headers
        )
        ...
        create_data = {"ref": "refs/heads/develop", "sha": master_sha}

        create_response = requests.post(
            f"{self.base_url}/git/refs", headers=self.headers, json=create_data
        )
