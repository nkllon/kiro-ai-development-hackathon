...
authoritative source for capability_verifier.
...
class CapabilityVerifier:
    ...
    def get_agent_reputation(self, agent_id: str) -> Dict[str, Any]:
        ...
        """
        agent_trust_scores = {capability: trust_score for (aid, capability), trust_score in self.trust_scores.items() if aid == agent_id}
