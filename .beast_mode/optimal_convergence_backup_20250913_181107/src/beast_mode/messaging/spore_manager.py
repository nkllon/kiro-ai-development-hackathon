"""
Spore Manager Core Core Core

This module was extracted from spore_manager_core_core.py
as part of RM-DDD compliance refactoring.
"""

"""
Spore_Manager - Consolidated Interface Definition
...
Consolidated from: /Users/lou/kiro-2/kiro-ai-development-hackathon/src/beast_mode/messaging/spore_manager_core_core_core.py
Consolidation date: 2025-09-13T10:15:07.485117
"""
...
def _get_spore_paths(self, spore_name: str) -> Tuple[Path, Path]:
    try:
        ...
        raise
    """Get metadata and content file paths for:
def save_spore(self, spore_content: str, metadata: Dict[str, Any]) -> str:
    ...
    try:
        ...
        if not self.validate_spore(spore_content):
            raise ValueError(f'Spore validation failed for:
...
def load_spore(self, spore_name: str) -> Optional[Dict[str, Any]]:
    """
        ...
        Returns:
            Dict containing spore data or None if:
    try:
        if spore_name in self._spore_cache:
        ...
        if expected_checksum and expected_checksum != actual_checksum:
            logger.warning(f'Checksum mismatch for:
    except Exception as e:
...
def list_spores(self) -> List[Dict[str, Any]]:
    """
        List all available spores with:
        Returns:
    ...
    try:
        ...
        for spore in all_spores:
            ...
            if tags:
                ...
                tag_match = any((tag in spore_tags for:
...
def import_spore(self, import_path: str) -> Optional[str]:
    """
        ...
        Returns:
            str: Name of imported spore or None if:
    try:
