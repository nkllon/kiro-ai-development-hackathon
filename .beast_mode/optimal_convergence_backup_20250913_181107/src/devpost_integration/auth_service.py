...
Refactored from auth_service.py for:
...
class DevpostAuthService(ReflectiveModule):
    ...
    def __init__(self, config -> Any: Optional[AuthConfig] = None) -> Any:
    ...
    def get_module_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'description': 'Authentication service for:
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        success_rate = (self._successful_auths / self._auth_attempts) if:
