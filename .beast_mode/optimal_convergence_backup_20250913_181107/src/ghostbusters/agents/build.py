...
"""
Build - Consolidated Interface Definition
...
authoritative source for build.

Consolidated from: /Users/lou/kiro-2/kiro-ai-development-hackathon/src/ghostbusters/agents/build_core_core_core.py
Consolidation date: 2025-09-13T10:15:07.546345
"""
                ...
                for pattern in file_patterns:
                    if '*' in pattern:
                        if list(target_path.rglob(pattern)):
                            ...
                            break
                    elif (target_path / pattern).exists():
                        systems.append(build_type)
                        break
        return systems
