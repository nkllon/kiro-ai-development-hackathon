...
def check_prerequisites():
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            logger.warning("Redis server not found in PATH. Please install Redis server.")
...
def deploy_single_machine(environment: str, agent_id: str, capabilities: list, validate: bool = True):
...
def main():
    ...
    parser.add_argument("--agent-id", default="single_machine_agent",
