#!/usr/bin/env python3
"""
conflict_detector - conflict_detector module for DevPost integration

Refactored for RM-DDD compliance.
Single responsibility: conflict_detector functionality.
"""
...
class Unknown(ReflectiveModule):
    ...
    def reset_metrics(self) -> None:
        ...
        self._errors = 0
        self._start_time = datetime.now()
        logger.info("Metrics reset for conflict_detector module")
