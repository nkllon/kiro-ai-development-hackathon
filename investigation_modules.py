...
class ContentAnalyzer(InvestigationModule):
    ...
    def _perform_semantic_analysis(self, text: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "has_instructions": any(word in text_lower for word in ["click", "enter", "select", "choose"]),
            "has_warnings": any(word in text_lower for word in ["warning", "caution", "attention"]),
            "has_errors": any(word in text_lower for word in ["error", "invalid", "failed"]),
    ...
    def investigate(self, page_data: Dict[str, Any], context: Dict[str, Any] = None) -> InvestigationResult:
        ...
        try:
            ...
            return InvestigationResult(
                module_name=self.name,
                success=True,
                data={"tests": tests, "summary": f"{passed_tests}/{total_tests} tests passed"},
                confidence=confidence
            )
...
class InvestigationOrchestrator:
    ...
    def _generate_summary(self, results: Dict[str, InvestigationResult]) -> Dict[str, Any]:
