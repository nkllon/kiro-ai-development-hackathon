...
class NetworkTester:
                ...
                for message in self.pubsub.listen():
                    ...
                    if message['type'] == 'message':
                        ...
                        try:
                            ...
                            print(f"[{timestamp}] 📨 Raw: {raw_content}")
                            
                    elif message['type'] == 'subscribe':
                        print(f"✅ Subscribed to beast_mode_network")
    ...
    def send_message(self, message_data):
        ...
        try:
            ...
            print(f"📤 Sent message - {result} subscribers received it")
            return result
        except Exception as e:
    ...
    def run_test(self):
        ...
        if self.messages_received:
            ...
            for msg in self.messages_received:
                print(f"  [{msg['timestamp']}] {msg['sender']} → {msg['type']}")
                print(f"    Content: {msg['content']}")
        else:
            print(f"⚠️  No responses received")
            print(f"💡 Agents are listening but not responding to these message types")
