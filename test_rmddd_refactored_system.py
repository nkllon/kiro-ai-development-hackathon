...
def test_individual_investigation_modules():
    ...
    test_page_data = {
        ...
        "navigation": [
            ...
            {"text": "Back to Dashboard", "type": "link", "href": "https://devpost.com/dashboard"}
        ],
        "buttons": [
    ...
    print(f"   Structure Type: {structure_result.data.get('structure_type', 'unknown')}")
    print(f"   URL Pattern: {structure_result.data.get('url_pattern', {}).get('pattern', 'unknown')}")
    print(f"   Title Type: {structure_result.data.get('title_analysis', {}).get('type', 'unknown')}")
    ...
    print(f"   Interaction Patterns: {navigation_result.data.get('interaction_patterns', [])}")
    ...
    print(f"   Language Indicators: {content_result.data.get('language_indicators', [])}")
...
def test_refactored_ghostbusters_consultation():
    ...
    print(f"   Successful Modules: {investigation['successful_modules']}/{investigation['total_modules']}")
