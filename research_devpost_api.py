...
def research_devpost_api():
    ...
    for url in api_endpoints_to_check:
        try:
            ...
            if response.status_code == 200:
                ...
                api_indicators = ['api', 'endpoint', 'authentication', 'token', 'json', 'rest']
    ...
    try:
        ...
        if robots_response.status_code == 200:
            ...
            api_paths = [line for line in robots_content.split('\n') 
            ...
            print(f"❌ Could not access robots.txt (Status: {robots_response.status_code})")
            ...
            if response.status_code == 200:
                ...
                try:
                    ...
                    if 'data' in data:
                        ...
                        Path(f"devpost_graphql_schema.json").write_text(json.dumps(data, indent=2))
    ...
    for url in help_urls:
        try:
            ...
            if response.status_code == 200:
                ...
                content = response.text.lower()
                submission_terms = ['submit', 'api', 'token', 'authentication', 'project', 'hackathon']
