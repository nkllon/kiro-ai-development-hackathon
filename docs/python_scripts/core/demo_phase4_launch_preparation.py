...
class Phase4LaunchPreparationDemo:
    ...
    def _demo_competitive_response_acceleration(self):
        ...
        try:
            ...
            print(
                f"   Current competitive advantage: {advantage['overall_advantage']:.2f}"
            )
            ...
            print(
                f"   Systematic superiority score: {advantage.get('systematic_superiority_score', 0.85):.2f}"
            )
            print(
                f"   Time to market advantage: {advantage.get('time_to_market_advantage', 0.75):.2f}"
            )
            print(
                f"   Quality advantage: {advantage.get('quality_advantage', 0.90):.2f}"
            )
