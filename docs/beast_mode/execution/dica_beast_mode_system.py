    ...
    def phase_1_dica_rdi_attack(self):
        ...
        for i, file_path in enumerate(files_without_rdi):
            ...
            try:
                ...
                if processed % 100 == 0:
                    self.git_sync(
                        f"🎯 DICA RDI ATTACK - Phase 1: {processed:,}/{len(files_without_rdi):,} files processed"
                    )
    ...
    def phase_2_dica_health_attack(self):
        ...
        for i, file_path in enumerate(files_without_health):
            ...
            try:
                ...
                if processed % 100 == 0:
                    self.git_sync(
                        f"🎯 DICA HEALTH ATTACK - Phase 2: {processed:,}/{len(files_without_health):,} files processed"
                    )
    ...
    def phase_3_dica_registry_attack(self):
        ...
        for i, file_path in enumerate(files_without_registry):
            ...
            try:
                ...
                if processed % 100 == 0:
                    self.git_sync(
                        f"🎯 DICA REGISTRY ATTACK - Phase 3: {processed:,}/{len(files_without_registry):,} files processed"
                    )
