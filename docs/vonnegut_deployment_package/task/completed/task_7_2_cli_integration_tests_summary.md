...
5. `docs/task/completed/task_7_2_cli_integration_tests_summary.md` - This summary document
...
python -m src.spec_reconciliation.cli validate --terminology ../../summary/analysis/unified_rdi_rm_analysis_system_spec.md
