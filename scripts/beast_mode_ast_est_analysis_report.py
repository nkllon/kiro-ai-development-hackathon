...
class BeastModeASTESTAnalysisReport:
    ...
    def generate_ast_est_analysis_report(self):
        ...
        print(f"   🌳 Enhanced AST Implemented: {ast_est_analysis['enhanced_ast_implemented']}")
        print(f"   🔧 EST Recovery Strategies: {ast_est_analysis['est_recovery_strategies']}")
        print(f"   🎯 Token-Based Recovery: {ast_est_analysis['token_based_recovery']}")
        print(f"   📝 Line-by-Line Recovery: {ast_est_analysis['line_by_line_recovery']}")
        print(f"   🔍 Pattern-Based Recovery: {ast_est_analysis['pattern_based_recovery']}")
        print(f"   🧠 Context-Aware Recovery: {ast_est_analysis['context_aware_recovery']}")
        ...
        print("💾 Comprehensive AST/EST analysis report saved to .beast_mode/beast_mode_ast_est_analysis_report.json")
