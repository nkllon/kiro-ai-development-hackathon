#!/usr/bin/env python3
"""
Add prometheus.observatory.nkllon.com subdomain to tunnel configuration
"""
...
def update_tunnel_configuration():
    """Update tunnel configuration to include prometheus.observatory.nkllon.com"""
    print("🔧 Adding prometheus.observatory.nkllon.com to tunnel configuration...")
    ...
    # Create the updated tunnel configuration
...
def main():
    print("🌐 Adding Prometheus Subdomain to Tunnel Configuration")
    print("=" * 60)
    
    try:
        update_tunnel_configuration()
        
        print("\n✅ Tunnel configuration update completed!")
