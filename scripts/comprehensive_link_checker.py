#!/usr/bin/env python3
"""
Comprehensive Link Checker for Repository
Checks all document links and artifact links across all file types
"""
    ...
    def __init__(self, repo_root: str):
        ...
        self.link_patterns = {
            ...
            'text': [
                ...
                r'[a-zA-Z0-9_/.-]+\.(?:md|html|py|json|yaml|yml|txt|png|jpg|jpeg|gif|svg)',  # File references
            ]
        }
        ...
        self.file_extensions = {
            ...
            '.yml': 'yaml',
            '.txt': 'text',
            '.py': 'text',  # Python files might have string references
        }
...
def main():
    ...
    checker = ComprehensiveLinkChecker(repo_root)
    summary = checker.check_repository()
    
    # Generate report
    report_file = os.path.join(repo_root, "comprehensive_link_check_report.md")
    checker.generate_report(summary, report_file)
    
    # Print summary
    print(f"\n{'='*60}")
    print("COMPREHENSIVE LINK CHECK SUMMARY")
    print(f"{'='*60}")
