...
class SystemicRCAAnalyzer:
    ...
    def analyze_syntax_error_patterns(self):
                ...
                if file.endswith('.py'):
                    ...
                    try:
                        ...
                        if "expected an indented block" in error_msg:
                            ...
                            syntax_errors["unindent does not match any outer indentation level"] += 1
        ...
        self.symptom_analysis['syntax_errors'] = {
            ...
            'error_rate': len(error_files) / total_files * 100 if total_files > 0 else 0,
    ...
    def analyze_automated_modification_patterns(self):
        ...
        if os.path.exists(backup_dir):
            backup_files = list(Path(backup_dir).glob("*.compliance_improvement_backup_*"))
    ...
    def run_comprehensive_rca(self):
        ...
        print(f"Recommended Action: {rca_report['executive_summary']['recommended_action']}")
