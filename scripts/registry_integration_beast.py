...
def main():
    ...
    for module_path in modules:
        try:
            ...
            if "register_module(self)" in content and "from .reflective_module import" in content:
            ...
            if "def __init__" in enhanced_content and "register_module(self)" not in enhanced_content:
                enhanced_content = enhanced_content.replace(
                    "def __init__",
                    "def __init__"
                )
            ...
            if enhanced_content != content:
                ...
                logger.info(f"  ✅ Enhanced registry integration for {module_path.name}")
                modules_enhanced += 1
            else:
