...
class IntegrationTestRunner:
    ...
    def run_syntax_validation_test(self) -> TestResult:
        ...
        try:
            ...
            result = subprocess.run(['python3', 'scripts/code_generation_validator.py', 'src'], 
            ...
            return TestResult(
                ...
                passed=passed,
                message="Syntax validation completed successfully" if passed else "Syntax validation failed",
    ...
    def run_indentation_validation_test(self) -> TestResult:
        ...
        try:
            ...
            result = subprocess.run(['python3', 'scripts/indentation_validator.py', 'src/beast_mode/tool_health/tool_health_manager_services_part_26.py'], 
            ...
            return TestResult(
                ...
                passed=passed,
                message="Indentation validation completed successfully" if passed else "Indentation validation failed",
                duration=(datetime.now() - start_time).total_seconds(),
                details={
                    "returncode": result.returncode,
                    "stdout": result.stdout,
    ...
    def run_rdi_test_validation(self) -> TestResult:
        ...
        try:
            # Test RDI test execution
            result = subprocess.run(['python3', '-m', 'pytest', 'tests/unit/beast_mode/tool_health/test_tool_health_manager_services_part_26_rdi_traceable.py', '-v'], 
                                  capture_output=True, text=True, timeout=60)
            ...
            return TestResult(
                ...
                passed=passed,
                message="RDI tests executed successfully" if passed else "RDI tests failed",
                duration=(datetime.now() - start_time).total_seconds(),
                details={
                    "returncode": result.returncode,
                    "stdout": result.stdout,
    ...
    def run_template_generation_test(self) -> TestResult:
        ...
        try:
            ...
            result = subprocess.run(['python3', 'scripts/code_generation_templates.py', '--list'], 
                                  capture_output=True, text=True, timeout=30)
            ...
            return TestResult(
                ...
                passed=passed,
                message="Template generation system working" if passed else "Template generation failed",
                duration=(datetime.now() - start_time).total_seconds(),
                details={
                    "returncode": result.returncode,
                    "stdout": result.stdout,
    ...
    def run_prevention_framework_test(self) -> TestResult:
        ...
        try:
            ...
            return TestResult(
                ...
                passed=passed,
                message="All prevention components present" if passed else f"Missing components: {missing_components}",
                duration=(datetime.now() - start_time).total_seconds(),
                details={
