                ...
                for message in self.pubsub.listen():
                    ...
                    if message['type'] == 'message':
                        try:
                            ...
                            print(f"[{timestamp}] 📨 Response from {sender} ({msg_type})")
                            ...
                            print(f"[{timestamp}] 📨 Raw message: {message['data'].decode('utf-8')}")
...
def main():
    ...
    for i, message in enumerate(test_messages, 1):
        ...
        print(f"  Format: {message.get('message_type', message.get('type', 'unknown'))}")
