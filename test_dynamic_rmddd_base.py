...
def main():
    ...
    try:
        ...
        print(f"Manual Documentation Fields: {comparison_results['manual_docs_fields']}")
        print(f"Dynamic Documentation Fields: {comparison_results['dynamic_docs_fields']}")
        print(f"Dynamic Capabilities: {comparison_results['dynamic_capabilities']}")
        print(f"Dynamic Complexity Analysis: {comparison_results['dynamic_complexity']}")
        print(f"Dynamic Confidence Assessment: {comparison_results['dynamic_confidence']:.1%}")
