"""
Core data models and types for RM-DDD SDK.

This module defines the fundamental data structures used throughout
the RM-DDD framework for domain modeling and systematic development.
"""
...
class ModuleCapability:
    """Represents a capability provided by an RM module."""
    name: str
    description: str
    available: bool
    version: str
...
class DomainBoundaries:
    """Defines the boundaries of a domain context."""
    context: str
...
class AggregateBoundaries:
    """Defines the consistency boundaries of an aggregate."""
    aggregate_type: str
...
class DomainCriteria:
    """Criteria for domain-specific queries."""
...
class HealthIndicator:
    """Individual health indicator for monitoring."""
    name: str
    status: str
    value: Any
...
class PerformanceMetrics:
    """Performance metrics for RM components."""
...
@dataclass
class MigrationStep:
    """Represents a step in a systematic migration process."""
    step_id: str
    name: str
    description: str
...
@dataclass
class ContextMap:
    """Represents relationships between bounded contexts."""
    upstream_context: str
    downstream_context: str
    relationship_type: str  # partnership, customer_supplier, conformist, etc.
    integration_pattern: str  # events, api, shared_database, etc.
...
class DeploymentStrategy:
    """Represents a deployment strategy decision."""
    strategy_type: str  # modular_monolith, microservices, hybrid
    rationale: str
...
AggregateId = Union[str, int, UUID]
EventId = UUID
CorrelationId = UUID
CausationId = UUID
