...
class SharedKernelGovernance(ABC):
    ...
    @abstractmethod
    def can_modify_element(self, 
                          element: SharedElement, 
                          modifier_context: str) -> bool:
        """
...
class SharedKernel(DomainReflectiveModule):
    ...
    def add_element(self, 
                   ...
                   owner_context: str,
                   description: str = "",
                   definition: Optional[Dict[str, Any]] = None) -> SharedElement:
        """
    ...
    def add_consumer(self, element_id: UUID, consumer_context: str):
        ...
        if element_id not in self._elements:
            raise DomainException(
                f"Shared element {element_id} not found",
    ...
    def propose_change(self, 
                      ...
                      proposed_by: str,
                      rationale: str = "",
                      migration_guide: str = "") -> SharedKernelChange:
        """
