...
class DomainContextInitializer(DomainReflectiveModule):
    ...
    def initialize_bounded_context(self, 
                                 config: BoundedContextConfig,
                                 project_path: Path) -> DomainSetupResult:
        """
    ...
    def _setup_context_structure(self, 
                               config: BoundedContextConfig, 
                               project_path: Path) -> DomainSetupResult:
...
'''
    ...
    def _create_value_object_file(self, 
                                config: BoundedContextConfig, 
                                vo_name: str, 
                                context_path: Path) -> Path:
...
'''
    ...
    def _create_domain_service_file(self, 
                                  config: BoundedContextConfig, 
                                  service_name: str, 
                                  context_path: Path) -> Path:
...
'''
    ...
    def _create_repository_file(self, 
                              config: BoundedContextConfig, 
                              repo_name: str, 
                              context_path: Path) -> Path:
...
'''
    ...
    def _create_context_config_file(self, 
                                  config: BoundedContextConfig, 
                                  context_path: Path) -> Path:
        """Create context configuration file."""
...
'''
    ...
    def get_initialization_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'success_rate': len(successful_contexts) / max(len(self._initialized_contexts), 1),
