"""
Domain validation utilities for RM-DDD framework.

This module provides comprehensive validation utilities for domain models,
including entity validation, aggregate boundary checking, and business
rule validation with structured reporting.
"""
...
class DomainValidator:
    ...
    def _initialize_default_rules(self):
        ...
        self.add_rule('entity', ValidationRule(
            name="entity_has_id",
        ...
        self.add_rule('aggregate', ValidationRule(
        ...
        self.add_rule('service', ValidationRule(
        ...
        self.add_rule('value_object', ValidationRule(
...
alidate_aggregate(self, aggregate: AggregateRoot) -> ValidationResult:
        ...
        # Apply entity rules first (aggregate is an entity)
        entity_result = self.validate_entity(aggregate)
        result.merge(entity_result)
        
        # Apply aggregate-specific rules
    ...
    def validate_value_object(self, value_object: ValueObject) -> ValidationResult:
        ...
        # Apply value object-specific rules
    ...
    def _validate_aggregate_size(self, aggregate: AggregateRoot) -> ValidationResult:
        ...
        # Check if aggregate has size limit metadata
        max_size = getattr(aggregate.__class__, '_max_aggregate_size', 100)
        
        # Count aggregate members (simplified - would need actual implementation)
    ...
    def _validate_service_statelessness(self, service: DomainService) -> ValidationResult:
        ...
        # Check for instance variables that might indicate state
        instance_vars = [attr for attr in dir(service) 
    ...
    def _validate_value_object_immutability(self, value_object: ValueObject) -> ValidationResult:
        ...
        # Check if class has immutability markers
        ...
        # Check for setter methods that might violate immutability
        setter_methods = [method for method in dir(value_object) 
    ...
    def _count_aggregate_members(self, aggregate: AggregateRoot) -> int:
        ...
        # This would need to be implemented based on actual aggregate structure
        # For now, return a placeholder count
        member_count = 0
        
        # Count collections that might contain entities
...
class BusinessRuleValidator:
    ...
    def _sort_rules_by_dependencies(self, rule_names: List[str]) -> List[str]:
        ...
        # Simplified implementation - in practice, you'd implement proper topological sort
        sorted_rules = []
        ...
        while remaining_rules:
            ...
            for rule_name in remaining_rules:
                dependencies = self._rule_dependencies.get(rule_name, [])
                if all(dep not in remaining_rules for dep in dependencies):
                    ready_rules.append(rule_name)
            ...
            # Add ready rules and remove from remaining
...
class InvariantValidator:
    ...
    complex invariant expressions and validation contexts.
    """
    ...
    def validate_invariants(self, target: Any, invariant_names: Optional[List[str]] = None) -> ValidationResult:
        ...
        for invariant_name in invariants_to_validate:
            try:
                ...
                # Evaluate the invariant expression
    ...
    def _evaluate_invariant(self, target: Any, expression: str, context: Dict[str, Any]) -> bool:
        ...
        # Add target attributes to context
