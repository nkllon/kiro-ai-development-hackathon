...
class LearningNavigator:
    ...
    def _analyze_page_indicators(self) -> Dict[str, Any]:
        ...
        form_indicators = self.page.query_selector_all(
    ...
    def navigate_with_learning(self):
        ...
        try:
            ...
            while navigation_count < max_navigations:
                ...
                print(
                    f"📊 Stats: {self.navigation_stats['successful_navigations']}/{self.navigation_stats['total_attempts']} success rate"
                )
                ...
                success = self._attempt_navigation_with_learning(
    ...
    def _find_next_step_with_learning(
    ...
    def _attempt_navigation_with_learning(
        self, next_step: Dict[str, Any], current_state: Dict[str, Any]
    ) -> bool:
        """Attempt navigation with learning."""
