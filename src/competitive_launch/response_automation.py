...
from .models import (
    CompetitorMove, ThreatLevel, CompetitiveAdvantage, 
    SystematicMetrics, FMHImplementation, RequirementsDrivenEvidence
)
...
class CompetitiveResponseAutomation:
    ...
    def get_response_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "success_rate": self.successful_responses / max(self.total_responses_generated, 1),
    ...
    def _analyze_competitive_threat(self, move: CompetitorMove) -> Dict[str, Any]:
        ...
        return {
            ...
            "urgency_level": "high" if threat_score > 0.7 else "medium" if threat_score > 0.4 else "low",
    ...
    def _execute_strategy_steps(
        ...
        for i, step in enumerate(strategy.implementation_plan):
            try:
                ...
                time.sleep(0.1)  # In real implementation, would be actual execution time
    ...
    def _update_performance_metrics(self, execution: ResponseExecution):
        ...
        if execution.started_at and execution.completed_at:
            execution_time = (execution.completed_at - execution.started_at).total_seconds() / 3600  # hours
            ...
            if total_executions == 1:
                ...
                self.average_response_time_hours = (
                    (self.average_response_time_hours * (total_executions - 1) + execution_time) / total_executions
                )
