...
class MakefilePerformanceOptimizer(ReflectiveModule):
    ...
    def get_module_info(self) -> Dict[str, Any]:
        """Metadata required by ReflectiveModule contract."""
        return {
            "module_id": self.module_id,
            "name": "Makefile Performance Optimizer",
            "version": "1.0.0",
    ...
    def get_capabilities(self) -> List[ModuleCapability]:
        """Capability declaration for orchestration systems."""
        return [
    ...
    def get_health_status(self) -> ModuleHealth:
        """Return current optimizer health."""
    ...
    def graceful_degradation(self) -> GracefulDegradationResult:
        """Describe fallback behaviour when performance features are limited."""
        remaining = [ModuleCapability.CORE_FUNCTIONALITY]
        degraded = [ModuleCapability.DATA_PROCESSING, ModuleCapability.MONITORING]
