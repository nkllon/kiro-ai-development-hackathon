"""
Notification NotificationMessage Module
...
from typing import Dict, List, Any, Optionalfrom ..interfaces.notificationmessage_interface import NotificationMessage
