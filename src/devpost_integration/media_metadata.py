#!/usr/bin/env python3
"""
media_metadata - media_metadata module for DevPost integration

Refactored for RM-DDD compliance.
Single responsibility: media_metadata functionality.
"""
...
class Unknown(ReflectiveModule):
    ...
    def reset_metrics(self) -> None:
        ...
        self._errors = 0
        self._start_time = datetime.now()
        logger.info("Metrics reset for media_metadata module")
