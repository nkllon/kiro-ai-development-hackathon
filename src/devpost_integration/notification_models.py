"""
Notification Models for DevPost Integration

This module contains notification-related classes for
managing notifications, reminders, and messaging.
...
class NotificationSettings(ReflectiveModule):
    ...
    def _get_default_settings(self) -> Dict[str, Any]:
        ...
        return {
            "enabled": True,
            "timing": NotificationTiming.DAILY,
            "channels": ["email"],
    ...
    def get_module_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "timing": self.timing.value if hasattr(self.timing, 'value') else str(self.timing),
    ...
    def get_capabilities(self) -> List[ModuleCapability]:
        ...
        return [
            ModuleCapability("settings_management", "Manage notification settings"),
            ModuleCapability("timing_control", "Control notification timing"),
            ModuleCapability("channel_management", "Manage notification channels"),
            ModuleCapability("preference_control", "Control user preferences")
        ]
...
class NotificationMessage(ReflectiveModule):
    ...
    def get_capabilities(self) -> List[ModuleCapability]:
        """Get module capabilities."""
        return [
            ModuleCapability("message_management", "Manage notification messages"),
            ModuleCapability("delivery_tracking", "Track message delivery"),
            ModuleCapability("recipient_management", "Manage message recipients")
        ]
