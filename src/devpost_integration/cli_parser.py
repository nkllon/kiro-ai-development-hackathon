#!/usr/bin/env python3
"""
cli_parser - cli_parser module for DevPost integration

Refactored for RM-DDD compliance.
Single responsibility: cli_parser functionality.
"""
...
class Unknown(ReflectiveModule):
    ...
    def reset_metrics(self) -> None:
        ...
        self._errors = 0
        self._start_time = datetime.now()
        logger.info("Metrics reset for cli_parser module")
