#!/usr/bin/env python3
"""
auth_session_manager - auth_session_manager module for DevPost integration

Refactored for RM-DDD compliance.
Single responsibility: auth_session_manager functionality.
"""
...
class AuthSessionManager(ReflectiveModule):
    ...
    def reset_metrics(self) -> None:
        ...
        self._errors = 0
        self._start_time = datetime.now()
        logger.info("Metrics reset for auth_session_manager module")
