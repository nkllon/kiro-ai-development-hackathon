"""
Notification NotificationSettings Module
...
from typing import Dict, List, Any, Optionalfrom ..interfaces.notificationsettings_interface import NotificationSettings
