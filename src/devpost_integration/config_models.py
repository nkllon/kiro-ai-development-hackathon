"""
Configuration Models for DevPost Integration

This module contains configuration-related classes for
managing DevPost integration settings and preferences.
...
class DevpostConfig(ReflectiveModule):
    ...
    def get_capabilities(self) -> List[ModuleCapability]:
        ...
        return [
            ModuleCapability("config_management", "Manage configuration settings"),
            ModuleCapability("validation", "Validate configuration values"),
            ModuleCapability("export_import", "Export and import configurations")
        ]
...
class GlobalSettings(ReflectiveModule):
    ...
    def get_capabilities(self) -> List[ModuleCapability]:
        """Get module capabilities."""
        return [
            ModuleCapability("settings_management", "Manage global settings"),
            ModuleCapability("theme_control", "Control UI themes"),
            ModuleCapability("localization", "Manage language settings")
        ]
