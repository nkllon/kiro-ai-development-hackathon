#!/usr/bin/env python3
"""
project_context_manager - project_context_manager module for DevPost integration

Refactored for RM-DDD compliance.
Single responsibility: project_context_manager functionality.
"""
...
class Unknown(ReflectiveModule):
    ...
    def reset_metrics(self) -> None:
        ...
        self._errors = 0
        self._start_time = datetime.now()
        logger.info("Metrics reset for project_context_manager module")
