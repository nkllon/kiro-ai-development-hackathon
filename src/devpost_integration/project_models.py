"""
Project Models for DevPost Integration

This module contains project-related data structures for
managing DevPost projects, team members, and submissions.
...
class DevpostProject(ReflectiveModule):
    ...
    def get_capabilities(self) -> List[ModuleCapability]:
        ...
        return [
            ModuleCapability("project_management", "Manage project data"),
            ModuleCapability("team_management", "Manage team members"),
            ModuleCapability("submission_tracking", "Track submission status"),
            ModuleCapability("deadline_management", "Manage project deadlines")
        ]
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "team_member_count": len(self.team_members),
            "status": self.status.value if hasattr(self.status, 'value') else str(self.status),
            "has_deadline": self.submission_deadline is not None
        }
...
class TeamMember(ReflectiveModule):
    ...
    def get_capabilities(self) -> List[ModuleCapability]:
        """Get module capabilities."""
        return [
            ModuleCapability("member_management", "Manage team member data"),
            ModuleCapability("role_management", "Manage member roles"),
            ModuleCapability("permission_control", "Control member permissions")
        ]
