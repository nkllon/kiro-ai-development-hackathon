#!/usr/bin/env python3
"""
media_formats - media_formats module for DevPost integration

Refactored for RM-DDD compliance.
Single responsibility: media_formats functionality.
"""
...
class Unknown(ReflectiveModule):
    ...
    def reset_metrics(self) -> None:
        ...
        self._errors = 0
        self._start_time = datetime.now()
        logger.info("Metrics reset for media_formats module")
