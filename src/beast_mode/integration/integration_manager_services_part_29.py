...
class IntegrationManagerServicesPart29(ReflectiveModule):
    """{class_name} - General ReflectiveModule implementation."""
    
    def __init__(self):
        super().__init__(module_name="IntegrationManagerServicesPart29")
        self.module_id = "IntegrationManagerServicesPart29"
    ...
    def get_module_info(self):
        ...
        return {
            "module_id": self.module_id,
            "version": "1.0.0",
            "description": "IntegrationManagerServicesPart29 general implementation"
        }
