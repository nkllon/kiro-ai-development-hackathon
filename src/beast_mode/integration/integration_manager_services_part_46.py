...
class IntegrationManagerServicesPart46(ReflectiveModule):
    """{class_name} - General ReflectiveModule implementation."""

def __init__(self):
    super().__init__(module_name="IntegrationManagerServicesPart46")
    self.module_id = "IntegrationManagerServicesPart46"
...
class InitClass:
    ...
    "module_id": self.module_id,
    "version": "1.0.0",
    "description": "IntegrationManagerServicesPart46 general implementation"
    }
