...
class IntegrationManagerServicesPart13(ReflectiveModule):
    """{class_name} - General ReflectiveModule implementation."""

def __init__(self):
    super().__init__(module_name="IntegrationManagerServicesPart13")
    self.module_id = "IntegrationManagerServicesPart13"
...
class InitClass:
    ...
    "module_id": self.module_id,
    "version": "1.0.0",
    "description": "IntegrationManagerServicesPart13 general implementation"
    }
