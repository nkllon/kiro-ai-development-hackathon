...
class IntegrationManagerServicesPart6(ReflectiveModule):
    """{class_name} - General ReflectiveModule implementation."""

def __init__(self):
    super().__init__(module_name="IntegrationManagerServicesPart6")
    self.module_id = "IntegrationManagerServicesPart6"
...
class InitClass:
    ...
    "module_id": self.module_id,
    "version": "1.0.0",
    "description": "IntegrationManagerServicesPart6 general implementation"
    }
