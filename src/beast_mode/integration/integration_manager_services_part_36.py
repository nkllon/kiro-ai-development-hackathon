...
class IntegrationManagerServicesPart36(ReflectiveModule):
    """{class_name} - General ReflectiveModule implementation."""

def __init__(self):
    super().__init__(module_name="IntegrationManagerServicesPart36")
    self.module_id = "IntegrationManagerServicesPart36"
...
class InitClass:
    ...
    "module_id": self.module_id,
    "version": "1.0.0",
    "description": "IntegrationManagerServicesPart36 general implementation"
    }
