...
class IntegrationManagerServicesPart33(ReflectiveModule):
    """{class_name} - General ReflectiveModule implementation."""

def __init__(self):
    super().__init__(module_name="IntegrationManagerServicesPart33")
    self.module_id = "IntegrationManagerServicesPart33"
...
class InitClass:
    ...
    "module_id": self.module_id,
    "version": "1.0.0",
    "description": "IntegrationManagerServicesPart33 general implementation"
    }
