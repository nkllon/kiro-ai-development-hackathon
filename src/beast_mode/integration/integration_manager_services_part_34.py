...
class IntegrationManagerServicesPart34(ReflectiveModule):
    """{class_name} - General ReflectiveModule implementation."""

def __init__(self):
    super().__init__(module_name="IntegrationManagerServicesPart34")
    self.module_id = "IntegrationManagerServicesPart34"
...
class InitClass:
    ...
    "module_id": self.module_id,
    "version": "1.0.0",
    "description": "IntegrationManagerServicesPart34 general implementation"
    }
