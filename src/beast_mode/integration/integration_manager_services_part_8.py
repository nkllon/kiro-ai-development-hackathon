...
class IntegrationManagerServicesPart8(ReflectiveModule):
    """{class_name} - General ReflectiveModule implementation."""
    
    def __init__(self):
        super().__init__(module_name="IntegrationManagerServicesPart8")
        self.module_id = "IntegrationManagerServicesPart8"
    ...
    def get_module_info(self):
        ...
        return {
            "module_id": self.module_id,
            "version": "1.0.0",
            "description": "IntegrationManagerServicesPart8 general implementation"
        }
