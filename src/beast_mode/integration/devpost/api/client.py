        ...
        try:
            ...
            for deadline_data in deadlines:
                ...
                processed_deadline = {
                    ...
                    "notification_settings": deadline_data.get("notification_settings", {}),
    ...
    async def validate_project_requirements(
        ...
        try:
            ...
            result = {
                ...
                "warnings": response_data.get("warnings", []),
                "ready_for_submission": response_data.get("ready_for_submission", False),
                "validated_at": response_data.get("validated_at", datetime.now().isoformat())
            }
    ...
    async def cancel_deadline_notification(
        ...
        try:
            ...
            result = {
                "success": response_data.get("success", True),
                "notification_id": notification_id,
                "cancelled_at": response_data.get("cancelled_at", datetime.now().isoformat()),
                "previous_status": response_data.get("previous_status")
            }
