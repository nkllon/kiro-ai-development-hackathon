...
class IntegrationManagerServicesPart44(ReflectiveModule):
    """{class_name} - General ReflectiveModule implementation."""

def __init__(self):
    super().__init__(module_name="IntegrationManagerServicesPart44")
    self.module_id = "IntegrationManagerServicesPart44"
...
class InitClass:
    ...
    "module_id": self.module_id,
    "version": "1.0.0",
    "description": "IntegrationManagerServicesPart44 general implementation"
    }
