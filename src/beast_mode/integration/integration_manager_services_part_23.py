...
class IntegrationManagerServicesPart23(ReflectiveModule):
    """{class_name} - General ReflectiveModule implementation."""

def __init__(self):
    super().__init__(module_name="IntegrationManagerServicesPart23")
    self.module_id = "IntegrationManagerServicesPart23"
...
class InitClass:
    ...
    "module_id": self.module_id,
    "version": "1.0.0",
    "description": "IntegrationManagerServicesPart23 general implementation"
    }
