...
class IntegrationManagerServicesPart48(ReflectiveModule):
    """{class_name} - General ReflectiveModule implementation."""

def __init__(self):
    super().__init__(module_name="IntegrationManagerServicesPart48")
    self.module_id = "IntegrationManagerServicesPart48"
...
class InitClass:
    ...
    "module_id": self.module_id,
    "version": "1.0.0",
    "description": "IntegrationManagerServicesPart48 general implementation"
    }
