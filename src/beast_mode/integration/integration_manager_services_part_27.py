...
class IntegrationManagerServicesPart27(ReflectiveModule):
    """{class_name} - General ReflectiveModule implementation."""

def __init__(self):
    super().__init__(module_name="IntegrationManagerServicesPart27")
    self.module_id = "IntegrationManagerServicesPart27"
...
class InitClass:
    ...
    "module_id": self.module_id,
    "version": "1.0.0",
    "description": "IntegrationManagerServicesPart27 general implementation"
    }
