...
authoritative source for performance_monitor.
...
class RCAPerformanceMonitor(ReflectiveModule):
    ...
    def get_performance_report(self) -> PerformanceReport:
        ...
        try:
            ...
            return PerformanceReport(total_operations=len(self.completed_operations), successful_operations=len(successful_ops), timeout_operations=len(timeout_ops), degraded_operations=len(degraded_ops), average_duration_seconds=avg_duration, average_memory_usage_mb=avg_memory, peak_memory_usage_mb=peak_memory, timeout_rate=timeout_rate, degradation_rate=degradation_rate, performance_trend=trend)
        except Exception as e:
