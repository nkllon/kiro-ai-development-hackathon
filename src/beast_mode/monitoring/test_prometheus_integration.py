...
from beast_mode.monitoring.prometheus_config import get_prometheus_config, is_prometheus_enabled
    ...
    try:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"✗ Metrics endpoint not accessible (status: {response.status_code})")
