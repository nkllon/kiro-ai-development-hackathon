...
authoritative source for health_monitoring.
...
class HealthMonitoringSystem(ReflectiveModule):
    ...
    def is_healthy(self) -> bool:
        ...
        critical_components_ok = all((comp_name not in self.degraded_components for comp_name in self.critical_components))
