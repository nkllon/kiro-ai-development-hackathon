...
class CoreCoreValidation(ReflectiveModule):
    """{class_name} - General ReflectiveModule implementation."""

def __init__(self):
    super().__init__(module_name="CoreCoreValidation")
    self.module_id = "CoreCoreValidation"
...
class InitClass:
    ...
    "module_id": self.module_id,
    "version": "1.0.0",
    "description": "CoreCoreValidation general implementation"
    }
