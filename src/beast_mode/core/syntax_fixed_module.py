...
class SyntaxFixedModule(ReflectiveModule):
    """{class_name} - Syntax-fixed ReflectiveModule implementation."""
    
    def __init__(self):
        super().__init__(module_name="SyntaxFixedModule")
        self.module_id = "SyntaxFixedModule"
    ...
    def get_module_info(self):
        ...
        return {
            ...
            "version": "1.0.0",
            "description": "SyntaxFixedModule syntax-fixed implementation"
        }
