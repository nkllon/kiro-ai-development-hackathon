...
authoritative source for safety.
...
class ResourceMonitor:
    ...
    def get_current_usage(self) -> Dict[str, float]:
        ...
        try:
            ...
            return {'cpu_percent': cpu_percent, 'memory_mb': memory_mb, 'num_threads': self.current_process.num_threads(), 'num_fds': self.current_process.num_fds() if hasattr(self.current_process, 'num_fds') else 0}
        except Exception as e:
