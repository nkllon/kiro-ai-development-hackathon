...
class SafeCLIExecutor:
    ...
    def execute_safe(self, 
        ...
        try:
            ...
            self.logger.info(f"Execution {execution_id} completed: {result.status.value}")
            return result
    ...
    def _execute_asynchronous(self, 
        ...
        return self._execute_synchronous(command, config, env, execution_id, progress_callback)
    ...
    def get_execution_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "success_rate": status_counts.get("completed", 0) / len(self.execution_history) * 100
        }
