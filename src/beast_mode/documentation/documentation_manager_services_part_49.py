...
class DocumentationManagerServicesPart49(ReflectiveModule):
    """{class_name} - Documentation ReflectiveModule implementation."""

def __init__(self):
    super().__init__(module_name="DocumentationManagerServicesPart49")
    self.module_id = "DocumentationManagerServicesPart49"
...
class InitClass:
    ...
    "module_id": self.module_id,
    "version": "1.0.0",
    "description": "DocumentationManagerServicesPart49 documentation implementation"
    }
