...
class DocumentationManagerServicesPart22(ReflectiveModule):
    """{class_name} - Documentation ReflectiveModule implementation."""

def __init__(self):
    super().__init__(module_name="DocumentationManagerServicesPart22")
    self.module_id = "DocumentationManagerServicesPart22"
...
class InitClass:
    ...
    "module_id": self.module_id,
    "version": "1.0.0",
    "description": "DocumentationManagerServicesPart22 documentation implementation"
    }
