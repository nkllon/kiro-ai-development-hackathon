...
authoritative source for document_management_rm.
...
class DocumentManagementRM(ReflectiveModule):
    ...
    def enforce_rm_documentation_constraint(self, rm_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            rm_documents = [self.document_registry[doc_id] for doc_id in self.rm_document_mapping[rm_name]]
            compliance_issues = []
            ...
            if missing_types:
                compliance_issues.append({'issue': 'MISSING_RDI_DOCUMENTS', 'missing_types': [t.value for t in missing_types]})
