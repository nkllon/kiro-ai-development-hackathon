...
class DocumentationManagerServicesPart48(ReflectiveModule):
    """{class_name} - Documentation ReflectiveModule implementation."""

def __init__(self):
    super().__init__(module_name="DocumentationManagerServicesPart48")
    self.module_id = "DocumentationManagerServicesPart48"
...
class InitClass:
    ...
    "module_id": self.module_id,
    "version": "1.0.0",
    "description": "DocumentationManagerServicesPart48 documentation implementation"
    }
