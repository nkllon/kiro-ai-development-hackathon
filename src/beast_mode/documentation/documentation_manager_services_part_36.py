...
class DocumentationManagerServicesPart36(ReflectiveModule):
    """{class_name} - Documentation ReflectiveModule implementation."""

def __init__(self):
    super().__init__(module_name="DocumentationManagerServicesPart36")
    self.module_id = "DocumentationManagerServicesPart36"
...
class InitClass:
    ...
    "module_id": self.module_id,
    "version": "1.0.0",
    "description": "DocumentationManagerServicesPart36 documentation implementation"
    }
