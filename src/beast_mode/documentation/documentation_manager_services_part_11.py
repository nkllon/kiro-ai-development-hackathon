...
class DocumentationManagerServicesPart11(ReflectiveModule):
    """{class_name} - Documentation ReflectiveModule implementation."""

def __init__(self):
    super().__init__(module_name="DocumentationManagerServicesPart11")
    self.module_id = "DocumentationManagerServicesPart11"
...
class InitClass:
    ...
    "module_id": self.module_id,
    "version": "1.0.0",
    "description": "DocumentationManagerServicesPart11 documentation implementation"
    }
