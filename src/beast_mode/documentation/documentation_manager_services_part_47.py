...
class DocumentationManagerServicesPart47(ReflectiveModule):
    """{class_name} - Documentation ReflectiveModule implementation."""

def __init__(self):
    super().__init__(module_name="DocumentationManagerServicesPart47")
    self.module_id = "DocumentationManagerServicesPart47"
...
class InitClass:
    ...
    "module_id": self.module_id,
    "version": "1.0.0",
    "description": "DocumentationManagerServicesPart47 documentation implementation"
    }
