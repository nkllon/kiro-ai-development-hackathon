...
class DocumentationManagerServicesPart27(ReflectiveModule):
    """{class_name} - Documentation ReflectiveModule implementation."""

def __init__(self):
    super().__init__(module_name="DocumentationManagerServicesPart27")
    self.module_id = "DocumentationManagerServicesPart27"
...
class InitClass:
    ...
    "module_id": self.module_id,
    "version": "1.0.0",
    "description": "DocumentationManagerServicesPart27 documentation implementation"
    }
