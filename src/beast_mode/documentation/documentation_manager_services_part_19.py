...
class DocumentationManagerServicesPart19(ReflectiveModule):
    """{class_name} - Documentation ReflectiveModule implementation."""

def __init__(self):
    super().__init__(module_name="DocumentationManagerServicesPart19")
    self.module_id = "DocumentationManagerServicesPart19"
...
class InitClass:
    ...
    "module_id": self.module_id,
    "version": "1.0.0",
    "description": "DocumentationManagerServicesPart19 documentation implementation"
    }
