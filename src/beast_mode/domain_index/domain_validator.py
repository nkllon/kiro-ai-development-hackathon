...
authoritative source for domain_validator.
...
class DomainValidator(DomainSystemComponent):
    ...
    def _initialize_builtin_rules(self) -> None:
        ...
        def validate_tools(domain: Domain, context: Dict[str, Any]) -> List[HealthIssue]:
            ...
            return issues
        self._validation_rules.append(ValidationRule(name='tools_validation', description='Validate domain tools configuration', severity=IssueSeverity.INFO, category=IssueCategory.VALIDATION, validator_func=validate_tools))
