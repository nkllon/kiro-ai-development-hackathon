...
class MultiAgentCollaborationModel(ReflectiveModule):
    ...
    def _initialize_default_agents(self):
        ...
        self.agents = [
            Agent(
                ...
                capabilities=["system_design", "scalability", "patterns", "architecture_review"],
            ...
            Agent(
                ...
                name="Security Agent",
                capabilities=["security_analysis", "vulnerability_assessment", "compliance", "threat_modeling"],
            ...
            Agent(
                ...
                capabilities=["performance_analysis", "optimization", "monitoring", "scalability"],
            ...
            Agent(
                ...
                capabilities=["api_integration", "deployment", "monitoring", "orchestration"],
    ...
    def _generate_collaborative_output(self, task: Task, agents: List[Agent], 
                                     human_amplification: Dict[str, Any]) -> Dict[str, Any]:
