...
class DemoScriptGenerator:
    ...
    def generate_demo_script(
        ...
        script_content = self._generate_script_content(
            template, hackathon_config, systematic_evidence, 
            technical_assessment, content_guidelines
        )
...
"""
    ...
    def _apply_content_guidelines(
        ...
        if guidelines.max_technical_depth < 0.5:
            ...
            content[DemoSection.TECHNICAL_DEMONSTRATION] = content[DemoSection.TECHNICAL_DEMONSTRATION].replace(
                "Deep technical demo", "High-level feature showcase"
            )
