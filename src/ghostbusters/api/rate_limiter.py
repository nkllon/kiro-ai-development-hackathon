...
class RateLimiter:
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "rejection_rate": recent_rejected / max(1, recent_allowed + recent_rejected),
    ...
    def get_client_stats(self, client_id: str) -> Dict[str, Any]:
        ...
        for operation, bucket in client_buckets.items():
            ...
            stats["operations"][operation] = {
                ...
                "last_request": bucket["last_request"].isoformat() if bucket["last_request"] else None
            }
    ...
    def _get_operation_limits(self, operation: str) -> Dict[str, int]:
        ...
        return self._operation_limits.get(operation, {
    ...
    def _refill_bucket(self, bucket: Dict) -> None:
        ...
        if time_elapsed > 0:
            ...
            operation_limits = self._get_operation_limits("default")  # This should be passed in
            refill_rate = operation_limits["requests_per_minute"] / 60.0  # tokens per second
            tokens_to_add = time_elapsed * refill_rate
            
            # Add tokens but don't exceed burst size
            bucket["tokens"] = min(
                operation_limits["burst_size"],
