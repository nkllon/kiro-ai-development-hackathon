...
class GCPAuthorizationHandshake:
    ...
    def step_1_request_authorization(
        self,
        developer_email: str,
        project_name: str,
        billing_account_id: str,
    ...
    def step_2_enterprise_admin_review(
        self,
        request_id: str,
        admin_email: str,
        approved: bool,
        ...
        auth_response = AuthorizationResponse(
            ...
            expiration_date=(
                time.strftime(
                    "%Y-%m-%d", time.localtime(time.time() + 365 * 24 * 60 * 60)
                )
                if approved
                else None
            ),
        ...
        auth_request.status = (
            AuthorizationStatus.AUTHORIZED if approved else AuthorizationStatus.DENIED
        )
    ...
    def step_4_link_project_with_authorization(
        ...
        try:
            ...
            result = subprocess.run(
                [
                    ...
                    project_id,
                    "--billing-account",
                    auth_response.billing_account_id,
                ],
                capture_output=True,
                text=True,
                check=True,
    ...
    def step_5_apply_iam_permissions(
        self, project_id: str, developer_email: str, granted_roles: List[str]
    ) -> Dict[str, Any]:
    ...
    def run_complete_authorization_handshake(
        self,
        developer_email: str,
        project_name: str,
        billing_account_id: str,
        ...
        project_link = self.step_4_link_project_with_authorization(
            project_id, auth_request.request_id
        )
