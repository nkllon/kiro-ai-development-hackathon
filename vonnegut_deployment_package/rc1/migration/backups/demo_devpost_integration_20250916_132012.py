...
"""
        ...
        (self.demo_project_path / "package.json").write_text(
...
"""
        ...
        (self.demo_project_path / "screenshots" / "demo.png").write_text(
            "Demo screenshot placeholder"
        )
        (self.demo_project_path / "screenshots" / "architecture.png").write_text(
    ...
    def _demo_project_management(self):
        ...
        try:
            ...
            success = manager.connect_project(
                project_id="demo-project-123", local_path=self.demo_project_path
            )
    ...
    def _demo_preview_generation(self):
        ...
        try:
            ...
            print(
                f"• Project Description: {preview_data.project_metadata.description[:100]}..."
            )
            print(
                f"• Validation Status: {'Valid' if preview_data.validation_result.is_valid else 'Invalid'}"
            )
        ...
        try:
            ...
            devpost_project = DevpostProject(
                ...
                links=[
                    ProjectLink(
                        title="GitHub",
                        url="https://github.com/beast-mode/demo",
                        link_type="github",
                    )
                ],
            )
            ...
            print(
                f"• Validation Status: {'Valid' if validation_result.is_valid else 'Invalid'}"
            )
    ...
    def _demo_notifications(self):
        ...
        try:
            ...
            print(
                f"• Status Change Notification: {'Sent' if result else 'Not sent (desktop notifications may not be available)'}"
            )
            ...
            print(
                f"• Deadline Notification: {'Sent' if deadline_result else 'Not sent (desktop notifications may not be available)'}"
            )
