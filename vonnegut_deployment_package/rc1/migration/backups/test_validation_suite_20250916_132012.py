...
class TestInfrastructureValidator:
                ...
                for fixture in required_fixtures:
                    if f"def {fixture}" in content:
                        ...
                        recommendations.append(
                            f"Add {fixture} fixture to root conftest.py"
                        )
    ...
    def validate_requirements_coverage(self) -> ValidationResult:
        ...
        self.validation_results.append(result)
        print(
            f"  {'✅ PASSED' if passed else '❌ FAILED'}: Requirements coverage check"
        )
        print()
        return result
    ...
    def validate_health_checks(self) -> ValidationResult:
        ...
        components_to_test = [
            (
                ...
                "src.beast_mode.documentation.document_management_rm",
            ),
            (
                "InfrastructureIntegrationManager",
                "src.beast_mode.integration.infrastructure_integration_manager",
            ),
            (
                "SelfConsistencyValidator",
                "src.beast_mode.integration.self_consistency_validator",
            ),
        ...
        report = {
            ...
            "summary": {
                ...
                "infrastructure_health": (
                    "healthy" if overall_score >= 0.8 else "degraded"
                ),
            },
        }
